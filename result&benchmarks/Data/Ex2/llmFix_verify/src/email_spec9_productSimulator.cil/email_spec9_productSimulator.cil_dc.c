...

{
  ...
  iVar1 = ___ste_email_id0;
  if ((handle != 1) && (iVar1 = ___ste_email_id1, handle != 2)) {
    iVar1 = 0;
  }
  return iVar1;
}
...

{
  ...
  iVar1 = value;
  if ((handle != 1) && (iVar1 = ___ste_email_id0, handle == 2)) {
    ___ste_email_id1 = value;
  }
  ___ste_email_id0 = iVar1;
  return;
}
