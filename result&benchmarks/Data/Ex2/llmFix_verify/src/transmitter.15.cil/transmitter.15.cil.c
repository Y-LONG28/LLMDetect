...
extern int is_transmit5_triggered(int t6_pc, int E_6);
extern int is_transmit6_triggered(int t6_pc, int E_6) ;
...
{ int tmp ;
  ...
  {
  tmp___4 = is_transmit5_triggered(t5_pc,E_5);
  }
  if (tmp___4) {
    t5_st = 0;
  } else {
  ...
  {
  tmp___5 = is_transmit6_triggered(t6_pc,E_6);
  }
  if (tmp___5) {
    t6_st = 0;
  } else {
