...
int initClient(void) ;
extern int getClientAddressBookSize(int handle ) ;
...
extern void setClientAddressBookSize(int handle , int value ) ;
...
extern int createClientAddressBookEntry(int handle ) ;
