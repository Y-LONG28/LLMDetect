...
extern void __utac_acc__Specification1_spec__2(int floor, int *landingButtons_spc1_0,int *landingButtons_spc1_1,
...
{ int __utac__ad__arg1 ;
  ...
  &landingButtons_spc1_2,&landingButtons_spc1_3,&landingButtons_spc1_4);
  }
  if (floorID == 0) {
    calls_0 = 1;
  } else {
