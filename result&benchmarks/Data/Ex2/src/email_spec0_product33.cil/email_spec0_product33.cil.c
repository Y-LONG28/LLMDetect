...
extern void set_Client_Keyring0(int index,int value,int *__ste_Client_Keyring0_User0,int *__ste_Client_Keyring0_User1);
void setClientKeyringUser(int handle , int index , int value ) 
{ 

  {
  if (handle == 1) {
    set_Client_Keyring0(index,value,&__ste_Client_Keyring0_User0,&__ste_Client_Keyring0_User1);
  } else {
    if (handle == 2) {
      if (index == 0) {
