...
extern int createClientKeyringEntry(int handle ) ;
...
extern void setClientId(int handle , int value ) ;
...
extern int getEmailId(int handle ) ;
...
extern int getClientKeyringSize(int handle ) ;
int getClientForwardReceiver(int handle ) ;
extern int getClientId(int handle ) ;
...
int initEmail(void) ;
extern void setEmailId(int handle , int value ) ;
