...
int main_0() {
  ...
  __CPROVER_assume(!(tmp_var_2_int != (((y3 * local_28) + tmp_var_1_int) + x1)));
  __CPROVER_assume(!(x1 == 0));
  __CPROVER_assume(local_28 == (tmp_var_1_int + 1));
  y3 = y3 + 1;
  tmp_var_1_int = 0;
  x1 = x1 + -1;
  iVar2 = counter + 1;
  ...
  __CPAchecker_TMP_0 = bVar1;
  __CPROVER_assume(__CPAchecker_TMP_0 == 0);
  __CPROVER_assume(tmp_var_2_int != ((y3 * local_28) + tmp_var_1_int));
  int __CPAchecker_TMP_6;
  __CPAchecker_TMP_6 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: y1*x2 + y2 == x1\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/mannadiv_unwindbound1_process_dc_iter1.c", 49, "__PRETTY_FUNCTION__");
}
