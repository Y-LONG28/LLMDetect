...
void f_2(int n) {
  ...
  __assert_fail("0 && \"Assertion failed: Condition in f function\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/afterrec-1_process_dc_iter1.c", 13, "__PRETTY_FUNCTION__");
}
