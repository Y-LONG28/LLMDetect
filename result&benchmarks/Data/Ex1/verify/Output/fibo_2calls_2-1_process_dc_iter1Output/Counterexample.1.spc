...
STATE USEFIRST ARG272 :
    MATCH "int fibo1(int n);" -> GOTO ARG273;
    TRUE -> STOP;

STATE USEFIRST ARG273 :
    MATCH "int fibo2(int n);" -> GOTO ARG274;
    TRUE -> STOP;

STATE USEFIRST ARG274 :
    MATCH "void assume(int cond)" -> GOTO ARG275;
    TRUE -> STOP;
...
STATE USEFIRST ARG278 :
    MATCH "int result;" -> GOTO ARG279;
    TRUE -> STOP;

STATE USEFIRST ARG279 :
    MATCH "int x;" -> GOTO ARG280;
    TRUE -> STOP;

STATE USEFIRST ARG280 :
    MATCH "iVar1 = fibo1(2);" -> GOTO ARG281;
    TRUE -> STOP;

STATE USEFIRST ARG281 :
    MATCH "" -> ASSUME {n == (2);} GOTO ARG282;
    TRUE -> STOP;

STATE USEFIRST ARG282 :
    MATCH "int iVar1;" -> ASSUME {n == (2);} GOTO ARG283;
    TRUE -> STOP;

STATE USEFIRST ARG283 :
    MATCH "int iVar2;" -> GOTO ARG284;
    TRUE -> STOP;

STATE USEFIRST ARG284 :
    MATCH "int n_local;" -> GOTO ARG285;
    TRUE -> STOP;

STATE USEFIRST ARG285 :
    MATCH "[!(n < 1)]" -> ASSUME {n == (2);} GOTO ARG286;
    TRUE -> STOP;

STATE USEFIRST ARG286 :
    MATCH "[!(n == 1)]" -> ASSUME {n == (2);} GOTO ARG287;
    TRUE -> STOP;

STATE USEFIRST ARG287 :
    MATCH "iVar1 = fibo2(n - 1);" -> GOTO ARG288;
    TRUE -> STOP;

STATE USEFIRST ARG288 :
    MATCH "" -> ASSUME {n == (1);} GOTO ARG289;
    TRUE -> STOP;

STATE USEFIRST ARG289 :
    MATCH "int iVar1;" -> ASSUME {n == (1);} GOTO ARG290;
    TRUE -> STOP;

STATE USEFIRST ARG290 :
    MATCH "int iVar2;" -> GOTO ARG291;
    TRUE -> STOP;

STATE USEFIRST ARG291 :
    MATCH "int n_local;" -> GOTO ARG292;
    TRUE -> STOP;

STATE USEFIRST ARG292 :
    MATCH "[!(n < 1)]" -> ASSUME {n == (1);} GOTO ARG293;
    TRUE -> STOP;

STATE USEFIRST ARG293 :
    MATCH "[n == 1]" -> ASSUME {n == (1);} GOTO ARG294;
    TRUE -> STOP;

STATE USEFIRST ARG294 :
    MATCH "iVar2 = 1;" -> ASSUME {iVar2 == (1);} GOTO ARG295;
    TRUE -> STOP;
...
STATE USEFIRST ARG296 :
    MATCH "return iVar2;" -> GOTO ARG297;
    TRUE -> STOP;
...
STATE USEFIRST ARG298 :
    MATCH "iVar2 = fibo2(n - 2);" -> GOTO ARG299;
    TRUE -> STOP;

STATE USEFIRST ARG299 :
    MATCH "" -> ASSUME {n == (0);} GOTO ARG300;
    TRUE -> STOP;

STATE USEFIRST ARG300 :
    MATCH "int iVar1;" -> ASSUME {n == (0);} GOTO ARG301;
    TRUE -> STOP;

STATE USEFIRST ARG301 :
    MATCH "int iVar2;" -> ASSUME {iVar2 == (1);} GOTO ARG302;
    TRUE -> STOP;

STATE USEFIRST ARG302 :
    MATCH "int n_local;" -> GOTO ARG303;
    TRUE -> STOP;

STATE USEFIRST ARG303 :
    MATCH "[n < 1]" -> ASSUME {n == (0);} GOTO ARG304;
    TRUE -> STOP;

STATE USEFIRST ARG304 :
    MATCH "iVar2 = 0;" -> ASSUME {iVar2 == (0);} GOTO ARG305;
    TRUE -> STOP;
...
STATE USEFIRST ARG306 :
    MATCH "return iVar2;" -> GOTO ARG307;
    TRUE -> STOP;
...
STATE USEFIRST ARG308 :
    MATCH "iVar2 = iVar2 + iVar1;" -> ASSUME {iVar2 == (1);} GOTO ARG309;
    TRUE -> STOP;
...
STATE USEFIRST ARG310 :
    MATCH "return iVar2;" -> GOTO ARG311;
    TRUE -> STOP;
...
STATE USEFIRST ARG312 :
    MATCH "[iVar1 == 1]" -> ASSUME {iVar1 == (1);} GOTO ARG313;
    TRUE -> STOP;
...
STATE USEFIRST ARG317 :
    MATCH "0 && \"Assertion failed: iVar1 should not equal 1\"" -> GOTO ARG318;
    TRUE -> STOP;

STATE USEFIRST ARG318 :
    MATCH "__assert_fail (\n# 57 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/fibo_2calls_2-1_process_dc_iter1.c\"\n   \"0 && \\\"Assertion failed: iVar1 should not equal 1\\\"\"\n# 57 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/fibo_2calls_2-1_process_dc_iter1.c\" 3 4\n   , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/fibo_2calls_2-1_process_dc_iter1.c\", 57, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
