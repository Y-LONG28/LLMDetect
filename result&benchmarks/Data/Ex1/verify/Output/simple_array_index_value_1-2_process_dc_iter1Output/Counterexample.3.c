...
int main_0() {
  ...
  uint tmp;
  tmp_var_1_uint = 0;
  __CPROVER_assume(!((array[9999]) < 10000));
  __CPROVER_assume(!(9999 < tmp_var_1_uint));
  __CPROVER_assume(tmp_var_1_uint != (auStack_9c60[tmp_var_1_uint]));
  int __CPAchecker_TMP_0;
  __CPAchecker_TMP_0 = 0;
  __VERIFIER_assert_1(__CPAchecker_TMP_0);
}
...
void __VERIFIER_assert_1(int cond) {
  ...
  __assert_fail("0 && \"Assertion failed: __VERIFIER_assert\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/simple_array_index_value_1-2_process_dc_iter1.c", 14, "__PRETTY_FUNCTION__");
}
