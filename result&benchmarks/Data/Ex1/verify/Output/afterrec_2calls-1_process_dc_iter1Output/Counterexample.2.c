...
void f2_2(int n) {
  ...
  __assert_fail("0 && \"Assertion failed in f2\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/afterrec_2calls-1_process_dc_iter1.c", 19, "__PRETTY_FUNCTION__");
}
