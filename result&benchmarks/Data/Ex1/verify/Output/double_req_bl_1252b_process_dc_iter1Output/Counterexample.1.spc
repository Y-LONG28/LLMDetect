...
STATE USEFIRST ARG299 :
    MATCH "int __fpclassify_double(double x);" -> GOTO ARG300;
    TRUE -> STOP;

STATE USEFIRST ARG300 :
    MATCH "double fmax_double(double x, double y);" -> GOTO ARG301;
    TRUE -> STOP;

STATE USEFIRST ARG301 :
    MATCH "int __signbit_double(double x);" -> GOTO ARG302;
    TRUE -> STOP;
...
STATE USEFIRST ARG305 :
    MATCH "int iVar1;" -> GOTO ARG306;
    TRUE -> STOP;

STATE USEFIRST ARG306 :
    MATCH "double in_a0;" -> GOTO ARG307;
    TRUE -> STOP;

STATE USEFIRST ARG307 :
    MATCH "double in_a1;" -> ASSUME {in_a1 == (4.9E-324);} GOTO ARG308;
    TRUE -> STOP;
...
STATE USEFIRST ARG309 :
    MATCH "double extraout_fa0;" -> ASSUME {extraout_fa0 == (2.0);} GOTO ARG310;
    TRUE -> STOP;

STATE USEFIRST ARG310 :
    MATCH "double res;" -> GOTO ARG311;
    TRUE -> STOP;

STATE USEFIRST ARG311 :
    MATCH "double y;" -> GOTO ARG312;
    TRUE -> STOP;

STATE USEFIRST ARG312 :
    MATCH "double x;" -> GOTO ARG313;
    TRUE -> STOP;

STATE USEFIRST ARG313 :
    MATCH "x_00 = fmax_double(in_a0, in_a1);" -> GOTO ARG314;
    TRUE -> STOP;

STATE USEFIRST ARG314 :
    MATCH "" -> ASSUME {y == (4.9E-324);} GOTO ARG315;
    TRUE -> STOP;

STATE USEFIRST ARG315 :
    MATCH "int iVar1;" -> ASSUME {y == (4.9E-324);} GOTO ARG316;
    TRUE -> STOP;

STATE USEFIRST ARG316 :
    MATCH "double dVar2;" -> GOTO ARG317;
    TRUE -> STOP;

STATE USEFIRST ARG317 :
    MATCH "iVar1 = __fpclassify_double(x);" -> GOTO ARG318;
    TRUE -> STOP;
...
STATE USEFIRST ARG319 :
    MATCH "int iVar1;" -> GOTO ARG320;
    TRUE -> STOP;

STATE USEFIRST ARG320 :
    MATCH "ieee_double_shape_type ew_u;" -> ASSUME {(&ew_u) == (4LL);} GOTO ARG321;
    TRUE -> STOP;

STATE USEFIRST ARG321 :
    MATCH "ew_u.value = x;" -> GOTO ARG322;
    TRUE -> STOP;

STATE USEFIRST ARG322 :
    MATCH "uint32_t lsw = ew_u.parts.lsw;" -> ASSUME {lsw == (1U);} GOTO ARG323;
    TRUE -> STOP;

STATE USEFIRST ARG323 :
    MATCH "uint32_t msw = ew_u.parts.msw;" -> ASSUME {msw == (4293918720U);} GOTO ARG324;
    TRUE -> STOP;

STATE USEFIRST ARG324 :
    MATCH "[!(((msw == 0) && (lsw == 0)) || ((msw == 0x80000000) && (lsw == 0)))]" -> ASSUME {msw == (4293918720U);} GOTO ARG329;
    TRUE -> STOP;
...
STATE USEFIRST ARG335 :
    MATCH "[!(((msw < 0x100000) || (0x7fefffff < msw)) &&\n               ((msw < 0x80100000) || (0xffefffff < msw)))]" -> ASSUME {msw == (4293918720U);} GOTO ARG337;
    MATCH "[((msw < 0x100000) || (0x7fefffff < msw)) &&\n               ((msw < 0x80100000) || (0xffefffff < msw))]" -> GOTO ARG340;
    TRUE -> STOP;

STATE USEFIRST ARG337 :
    MATCH "[((msw < 0x100000) || (0x7fefffff < msw)) &&\n               ((msw < 0x80100000) || (0xffefffff < msw))]" -> ASSUME {msw == (4293918720U);} GOTO ARG340;
    TRUE -> STOP;

STATE USEFIRST ARG340 :
    MATCH "[!(((msw < 0x100000) || (0x7fefffff < msw)) &&\n               ((msw < 0x80100000) || (0xffefffff < msw)))]" -> ASSUME {msw == (4293918720U);} GOTO ARG342;
    MATCH "[((msw < 0x100000) || (0x7fefffff < msw)) &&\n               ((msw < 0x80100000) || (0xffefffff < msw))]" -> GOTO ARG345;
    TRUE -> STOP;

STATE USEFIRST ARG342 :
    MATCH "[((msw < 0x100000) || (0x7fefffff < msw)) &&\n               ((msw < 0x80100000) || (0xffefffff < msw))]" -> ASSUME {msw == (4293918720U);} GOTO ARG345;
    TRUE -> STOP;

STATE USEFIRST ARG345 :
    MATCH "[!((msw < 0x100000) || ((x < 0 && (msw < 0x80100000))))]" -> ASSUME {msw == (4293918720U);} GOTO ARG350;
    TRUE -> STOP;

STATE USEFIRST ARG350 :
    MATCH "[!((msw < 0x100000) || ((x < 0 && (msw < 0x80100000))))]" -> GOTO ARG356;
    TRUE -> STOP;

STATE USEFIRST ARG356 :
    MATCH "[!(((msw == 0x7ff00000) && (lsw == 0)) ||\n                   ((msw == 0xfff00000) && (lsw == 0)))]" -> ASSUME {msw == (4293918720U);} GOTO ARG361;
    TRUE -> STOP;

STATE USEFIRST ARG361 :
    MATCH "[((msw == 0x7ff00000) && (lsw == 0)) ||\n                   ((msw == 0xfff00000) && (lsw == 0))]" -> ASSUME {msw == (4293918720U);} GOTO ARG362;
    MATCH "[!(((msw == 0x7ff00000) && (lsw == 0)) ||\n                   ((msw == 0xfff00000) && (lsw == 0)))]" -> GOTO ARG367;
    TRUE -> STOP;

STATE USEFIRST ARG362 :
    MATCH "[!(((msw == 0x7ff00000) && (lsw == 0)) ||\n                   ((msw == 0xfff00000) && (lsw == 0)))]" -> ASSUME {lsw == (1U);} GOTO ARG367;
    TRUE -> STOP;

STATE USEFIRST ARG367 :
    MATCH "iVar1 = 0;" -> ASSUME {iVar1 == (0);} GOTO ARG368;
    TRUE -> STOP;
...
STATE USEFIRST ARG380 :
    MATCH "return iVar1;" -> GOTO ARG381;
    TRUE -> STOP;
...
STATE USEFIRST ARG382 :
    MATCH "[iVar1 == 0]" -> ASSUME {iVar1 == (0);} GOTO ARG383;
    TRUE -> STOP;

STATE USEFIRST ARG383 :
    MATCH "dVar2 = 0.0;" -> ASSUME {dVar2 == (0.0);} GOTO ARG452;
    TRUE -> STOP;
...
STATE USEFIRST ARG454 :
    MATCH "return dVar2;" -> GOTO ARG455;
    TRUE -> STOP;
...
STATE USEFIRST ARG456 :
    MATCH "[(extraout_fa0 != 0.0) || (iVar1 = __signbit_double(x_00), iVar1 != 0)]" -> ASSUME {extraout_fa0 == (2.0);} GOTO ARG469;
    TRUE -> STOP;

STATE USEFIRST ARG469 :
    MATCH "(void) sizeof ((\n# 84 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/double_req_bl_1252b_process_dc_iter1.c\"\n       0 && \"Assertion failed: extraout_fa0 should be 0.0 and x_00 should not be negative\"\n# 84 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/double_req_bl_1252b_process_dc_iter1.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG470;
    TRUE -> STOP;
...
STATE USEFIRST ARG473 :
    MATCH "0 && \"Assertion failed: extraout_fa0 should be 0.0 and x_00 should not be negative\"" -> GOTO ARG474;
    TRUE -> STOP;

STATE USEFIRST ARG474 :
    MATCH "__assert_fail (\n# 84 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/double_req_bl_1252b_process_dc_iter1.c\"\n       \"0 && \\\"Assertion failed: extraout_fa0 should be 0.0 and x_00 should not be negative\\\"\"\n# 84 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/double_req_bl_1252b_process_dc_iter1.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/double_req_bl_1252b_process_dc_iter1.c\", 84, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
