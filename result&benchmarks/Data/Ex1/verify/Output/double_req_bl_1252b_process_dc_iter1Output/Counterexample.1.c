...
union __anon_type_ieee_double_shape_type {
  double value;
  struct __anon_type_1 parts;
} ;
typedef union __anon_type_ieee_double_shape_type ieee_double_shape_type;
...
int main_0();
double fmax_double_1(double x, double y);
int __fpclassify_double_2(double x);
int main_0() {
  int iVar1;
  double in_a0;
  double in_a1;
  ...
  double y;
  double x;
  x_00 = fmax_double_1(in_a0, in_a1);
  __CPROVER_assume(extraout_fa0 != 0.0);
  int __CPAchecker_TMP_3;
  __CPAchecker_TMP_3 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: extraout_fa0 should be 0.0 and x_00 should not be negative\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/double_req_bl_1252b_process_dc_iter1.c", 84, "__PRETTY_FUNCTION__");
}

double fmax_double_1(double x, double y) {
  int iVar1;
  double dVar2;
  iVar1 = __fpclassify_double_2(x);
...
int __fpclassify_double_2(double x) {
  ...
  __CPROVER_assume(!(msw == 0));
  __CPROVER_assume(!(msw == 2147483648U));
  __CPROVER_assume(!(msw < 1048576));
  __CPROVER_assume(2146435071 < msw);
  __CPROVER_assume(!(msw < 2148532224U));
  __CPROVER_assume(4293918719U < msw);
  __CPROVER_assume(!(msw < 1048576));
  __CPROVER_assume(!(x < 0));
  __CPROVER_assume(!(msw == 2146435072));
  __CPROVER_assume(msw == 4293918720U);
  __CPROVER_assume(!(lsw == 0));
  iVar1 = 0;
  return iVar1;
}
