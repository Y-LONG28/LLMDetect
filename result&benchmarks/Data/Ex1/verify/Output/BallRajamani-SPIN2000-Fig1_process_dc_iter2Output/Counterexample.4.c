...
int main_0();
int A_1(int a1, int a2);
int A_2(int a1, int a2);
int A_3(int a1, int a2);
int A_4(int a1, int a2);
int main_0() {
  int local_14;
  A_1(local_14, (unsigned int)(local_14 == 0));
  A_3(local_14, (unsigned int)(local_14 == 0));
  __CPROVER_assume(local_14 != 0);
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: local_14 should be 0\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/BallRajamani-SPIN2000-Fig1_process_dc_iter2.c", 34, "__PRETTY_FUNCTION__");
}
