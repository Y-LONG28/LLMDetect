...
struct __anon_type_EVP_PKEY_CTX {
} ;
typedef struct __anon_type_EVP_PKEY_CTX EVP_PKEY_CTX;
dummy d1 = {  };
dummy d2 = {  };
...
int main_0();
int init_1(EVP_PKEY_CTX *ctx);
dummy *get_dummy_2();
dummy *get_dummy_3();
int check_4(dummy *s1, dummy *s2);
int main_0() {
  int iVar1;
  EVP_PKEY_CTX *in_a0;
  dummy *s1;
  ...
  s1 = get_dummy_2();
  s2 = get_dummy_3();
  __CPROVER_assume(!(s1 == ((dummy *)0)));
  __CPROVER_assume(!(s1 != s2));
  uint64_t __CPAchecker_TMP_0;
  iVar1 = check_4(s1, s2);
  __CPAchecker_TMP_0 = ((((uint64_t )extraout_var) << 32) | iVar1) != 0;
  ...
  __assert_fail("0 && \"Assertion failed: main\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test21-2_process_dc_iter1.c", 84, "__PRETTY_FUNCTION__");
}
