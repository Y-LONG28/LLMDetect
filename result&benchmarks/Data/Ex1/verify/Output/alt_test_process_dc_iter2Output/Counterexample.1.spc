...
STATE USEFIRST ARG272 :
    MATCH "int globalState;" -> ASSUME {globalState == (0);} GOTO ARG273;
    TRUE -> STOP;

STATE USEFIRST ARG273 :
    MATCH "void __blast_assert(void);" -> GOTO ARG274;
    TRUE -> STOP;

STATE USEFIRST ARG274 :
    MATCH "void *l_malloc(int size);" -> GOTO ARG275;
    TRUE -> STOP;

STATE USEFIRST ARG275 :
    MATCH "void l_free(void *ptr);" -> GOTO ARG276;
    TRUE -> STOP;

STATE USEFIRST ARG276 :
    MATCH "void assume(int cond)" -> GOTO ARG277;
    TRUE -> STOP;

STATE USEFIRST ARG277 :
    MATCH "int main(int argc, char **argv)" -> GOTO ARG278;
    TRUE -> STOP;
...
STATE USEFIRST ARG279 :
    MATCH "(void)argc;" -> GOTO ARG280;
    TRUE -> STOP;

STATE USEFIRST ARG280 :
    MATCH "(void)argv;" -> GOTO ARG281;
    TRUE -> STOP;

STATE USEFIRST ARG281 :
    MATCH "void *ptr;" -> GOTO ARG282;
    TRUE -> STOP;

STATE USEFIRST ARG282 :
    MATCH "ptr = l_malloc(4);" -> GOTO ARG283;
    TRUE -> STOP;

STATE USEFIRST ARG283 :
    MATCH "" -> ASSUME {size == (4);} GOTO ARG284;
    TRUE -> STOP;

STATE USEFIRST ARG284 :
    MATCH "void *pvVar1;" -> ASSUME {size == (4);} GOTO ARG285;
    TRUE -> STOP;

STATE USEFIRST ARG285 :
    MATCH "pvVar1 = malloc((long)size);" -> ASSUME {pvVar1 == (8LL);} GOTO ARG286;
    TRUE -> STOP;

STATE USEFIRST ARG286 :
    MATCH "[pvVar1 != (void *)0x0]" -> ASSUME {pvVar1 == (8LL);} GOTO ARG287;
    MATCH "[!(pvVar1 != (void *)0x0)]" -> GOTO ARG291;
    TRUE -> STOP;

STATE USEFIRST ARG287 :
    MATCH "globalState = 1;" -> ASSUME {globalState == (1);} GOTO ARG289;
    TRUE -> STOP;
...
STATE USEFIRST ARG291 :
    MATCH "return pvVar1;" -> GOTO ARG292;
    TRUE -> STOP;
...
STATE USEFIRST ARG293 :
    MATCH "l_free(ptr);" -> GOTO ARG294;
    TRUE -> STOP;

STATE USEFIRST ARG294 :
    MATCH "" -> ASSUME {ptr == (8LL);} GOTO ARG295;
    TRUE -> STOP;

STATE USEFIRST ARG295 :
    MATCH "[(ptr != (void *)0x0) && (globalState != 1)]" -> ASSUME {ptr == (8LL);} GOTO ARG296;
    MATCH "[!((ptr != (void *)0x0) && (globalState != 1))]" -> GOTO ARG300;
    TRUE -> STOP;

STATE USEFIRST ARG296 :
    MATCH "[!((ptr != (void *)0x0) && (globalState != 1))]" -> ASSUME {globalState == (1);} GOTO ARG300;
    TRUE -> STOP;

STATE USEFIRST ARG300 :
    MATCH "globalState = 0;" -> ASSUME {globalState == (0);} GOTO ARG310;
    TRUE -> STOP;

STATE USEFIRST ARG310 :
    MATCH "free(ptr);" -> GOTO ARG311;
    TRUE -> STOP;

STATE USEFIRST ARG311 :
    MATCH "return;" -> GOTO ARG312;
    TRUE -> STOP;
...
STATE USEFIRST ARG313 :
    MATCH "l_free(ptr);" -> GOTO ARG314;
    TRUE -> STOP;

STATE USEFIRST ARG314 :
    MATCH "" -> ASSUME {ptr == (8LL);} GOTO ARG315;
    TRUE -> STOP;

STATE USEFIRST ARG315 :
    MATCH "[(ptr != (void *)0x0) && (globalState != 1)]" -> ASSUME {ptr == (8LL);} GOTO ARG316;
    TRUE -> STOP;

STATE USEFIRST ARG316 :
    MATCH "[(ptr != (void *)0x0) && (globalState != 1)]" -> ASSUME {globalState == (0);} GOTO ARG318;
    TRUE -> STOP;

STATE USEFIRST ARG318 :
    MATCH "__blast_assert();" -> GOTO ARG319;
    TRUE -> STOP;
...
STATE USEFIRST ARG324 :
    MATCH "0 && \"Assertion failed in __blast_assert\"" -> GOTO ARG325;
    TRUE -> STOP;

STATE USEFIRST ARG325 :
    MATCH "__assert_fail (\n# 21 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/alt_test_process_dc_iter2.c\"\n   \"0 && \\\"Assertion failed in __blast_assert\\\"\"\n# 21 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/alt_test_process_dc_iter2.c\" 3 4\n   , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/alt_test_process_dc_iter2.c\", 21, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
