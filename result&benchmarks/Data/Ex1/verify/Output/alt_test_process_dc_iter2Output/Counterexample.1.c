...
void *l_malloc_1(int size);
void l_free_2(void *ptr);
void l_free_3(void *ptr);
void __blast_assert_4();
int main_0(int argc, char **argv) {
  argc;
  argv;
  void *ptr;
...
void *l_malloc_1(int size) {
  ...
  __CPROVER_assume(pvVar1 != ((void *)0));
  globalState = 1;
  return pvVar1;
}

void l_free_2(void *ptr) {
  __CPROVER_assume(ptr != ((void *)0));
  __CPROVER_assume(!(globalState != 1));
  globalState = 0;
  free(ptr);
  return;
}
...
void __blast_assert_4() {
  ...
  __assert_fail("0 && \"Assertion failed in __blast_assert\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/alt_test_process_dc_iter2.c", 21, "__PRETTY_FUNCTION__");
}
