...
STATE USEFIRST ARG38_296_1 :
    MATCH "int main(void)" -> GOTO ARG38_297_1;
STATE USEFIRST ARG38_297_1 :
    MATCH "" -> GOTO ARG38_298_1;
STATE USEFIRST ARG38_298_1 :
    MATCH "uint local_1c;" -> GOTO ARG38_299_1;
STATE USEFIRST ARG38_299_1 :
    MATCH "uint local_18;" -> GOTO ARG38_300_1;
STATE USEFIRST ARG38_300_1 :
    MATCH "uint n;" -> GOTO ARG38_301_1;
STATE USEFIRST ARG38_301_1 :
    MATCH "uint y;" -> GOTO ARG38_302_1;
STATE USEFIRST ARG38_302_1 :
    MATCH "uint x;" -> GOTO ARG38_303_1;
STATE USEFIRST ARG38_303_1 :
    MATCH "local_18 = 0;" -> ASSUME {local_1c == (0U);local_18 == (0U);} GOTO ARG38;
    TRUE -> STOP;

STATE USEFIRST ARG38 :
    MATCH "assume(local_18 == 0);" -> GOTO ARG39;
    TRUE -> STOP;

STATE USEFIRST ARG39 :
    MATCH "" -> ASSUME {cond == (1);} GOTO ARG40;
    TRUE -> STOP;

STATE USEFIRST ARG40 :
    MATCH "[!(!cond)]" -> ASSUME {cond == (1);} GOTO ARG42;
    TRUE -> STOP;
...
STATE USEFIRST ARG54 :
    MATCH "n = local_1c" -> ASSUME {n == (0U);} GOTO ARG56;
    TRUE -> STOP;

STATE USEFIRST ARG56 :
    MATCH "[!(n != 0)]" -> ASSUME {n == (0U);} GOTO ARG60;
    TRUE -> STOP;

STATE USEFIRST ARG60 :
    MATCH "[local_18 == local_1c]" -> ASSUME {local_18 == (0U);local_1c == (0U);} GOTO ARG65;
    TRUE -> STOP;

STATE USEFIRST ARG65 :
    MATCH "(void) sizeof ((\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/count_up_down-2_process_dc_iter1.c\"\n       0 && \"Assertion failed: local_18 should not equal local_1c\"\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/count_up_down-2_process_dc_iter1.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG69_1_2;
STATE USEFIRST ARG69_0_2 :
    MATCH "(void) sizeof ((\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/count_up_down-2_process_dc_iter1.c\"\n       0 && \"Assertion failed: local_18 should not equal local_1c\"\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/count_up_down-2_process_dc_iter1.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG69_1_2;
STATE USEFIRST ARG69_1_2 :
    MATCH "(\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/count_up_down-2_process_dc_iter1.c\"\n       0 && \"Assertion failed: local_18 should not equal local_1c\"\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/count_up_down-2_process_dc_iter1.c\" 3 4\n       )" -> GOTO ARG69_2_2;
STATE USEFIRST ARG69_2_2 :
    MATCH "0" -> GOTO ARG69_3_2;
STATE USEFIRST ARG69_3_2 :
    MATCH "(void) sizeof ((\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/count_up_down-2_process_dc_iter1.c\"\n       0 && \"Assertion failed: local_18 should not equal local_1c\"\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/count_up_down-2_process_dc_iter1.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG69_4_2;
STATE USEFIRST ARG69_4_2 :
    MATCH "0 && \"Assertion failed: local_18 should not equal local_1c\"" -> GOTO ARG69;
    TRUE -> STOP;

STATE USEFIRST ARG69 :
    MATCH "__assert_fail (\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/count_up_down-2_process_dc_iter1.c\"\n       \"0 && \\\"Assertion failed: local_18 should not equal local_1c\\\"\"\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/count_up_down-2_process_dc_iter1.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/count_up_down-2_process_dc_iter1.c\", 30, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
