...
STATE USEFIRST ARG9_300_1 :
    MATCH "_Bool \n# 21 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound1_process_dc_iter1.c\"\n        bVar1;" -> GOTO ARG9_301_1;
...
STATE USEFIRST ARG11 :
    MATCH "iVar2 = counter + 1, bVar1 = counter < 1, counter = iVar2, bVar1" -> GOTO ARG13_1_2;
STATE USEFIRST ARG13_0_2 :
    MATCH "iVar2 = counter + 1, bVar1 = counter < 1, counter = iVar2, bVar1" -> GOTO ARG13_1_2;
STATE USEFIRST ARG13_1_2 :
    MATCH "iVar2 = counter + 1" -> GOTO ARG13_2_2;
STATE USEFIRST ARG13_2_2 :
    MATCH "bVar1 = counter < 1" -> GOTO ARG13_3_2;
...
STATE USEFIRST ARG13 :
    MATCH "[iVar2 = counter + 1, bVar1 = counter < 1, counter = iVar2, bVar1]" -> ASSUME {__CPAchecker_TMP_0 == (1);} GOTO ARG38;
    TRUE -> STOP;
...
STATE USEFIRST ARG43 :
    MATCH "[!(local_32 < x)]" -> ASSUME {x == (0LL);} GOTO ARG51;
    TRUE -> STOP;

STATE USEFIRST ARG51 :
    MATCH "x = x + 1;" -> GOTO ARG56_1_3;
STATE USEFIRST ARG56_0_3 :
    MATCH "x = x + 1;" -> GOTO ARG56_1_3;
STATE USEFIRST ARG56_1_3 :
    MATCH "y = z + y;" -> GOTO ARG56_2_3;
STATE USEFIRST ARG56_2_3 :
    MATCH "z = lStack_30 + z;" -> GOTO ARG56_3_3;
STATE USEFIRST ARG56_3_3 :
    MATCH "lStack_30 = lStack_30 + 6;" -> ASSUME {x == (1LL);y == (1LL);z == (7LL);lStack_30 == (12L);} GOTO ARG56;
    TRUE -> STOP;
...
STATE USEFIRST ARG58 :
    MATCH "iVar2 = counter + 1, bVar1 = counter < 1, counter = iVar2, bVar1" -> GOTO ARG62_1_4;
STATE USEFIRST ARG62_0_4 :
    MATCH "iVar2 = counter + 1, bVar1 = counter < 1, counter = iVar2, bVar1" -> GOTO ARG62_1_4;
STATE USEFIRST ARG62_1_4 :
    MATCH "iVar2 = counter + 1" -> GOTO ARG62_2_4;
STATE USEFIRST ARG62_2_4 :
    MATCH "bVar1 = counter < 1" -> GOTO ARG62_3_4;
STATE USEFIRST ARG62_3_4 :
    MATCH "counter = iVar2" -> GOTO ARG62_4_4;
STATE USEFIRST ARG62_4_4 :
    MATCH "__CPAchecker_TMP_0 = bVar1;" -> ASSUME {__CPAchecker_TMP_0 == (0);iVar2 == (2);bVar1 == (0);counter == (2);} GOTO ARG62;
    TRUE -> STOP;

STATE USEFIRST ARG62 :
    MATCH "[!(iVar2 = counter + 1, bVar1 = counter < 1, counter = iVar2, bVar1)]" -> ASSUME {__CPAchecker_TMP_0 == (0);} GOTO ARG64;
    TRUE -> STOP;

STATE USEFIRST ARG64 :
    MATCH "[!(lStack_30 != (x + 1) * 6)]" -> ASSUME {lStack_30 == (12L);} GOTO ARG66;
    TRUE -> STOP;

STATE USEFIRST ARG66 :
    MATCH "[y * 0xc + ((local_32 * 6) * y - y * lStack_30) != 0]" -> GOTO ARG70;
    TRUE -> STOP;

STATE USEFIRST ARG70 :
    MATCH "(void) sizeof ((\n# 64 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound1_process_dc_iter1.c\"\n       0 && \"6*a*x - x*z + 12*x == 0\"\n# 64 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound1_process_dc_iter1.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG73_1_5;
STATE USEFIRST ARG73_0_5 :
    MATCH "(void) sizeof ((\n# 64 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound1_process_dc_iter1.c\"\n       0 && \"6*a*x - x*z + 12*x == 0\"\n# 64 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound1_process_dc_iter1.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG73_1_5;
STATE USEFIRST ARG73_1_5 :
    MATCH "(\n# 64 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound1_process_dc_iter1.c\"\n       0 && \"6*a*x - x*z + 12*x == 0\"\n# 64 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound1_process_dc_iter1.c\" 3 4\n       )" -> GOTO ARG73_2_5;
STATE USEFIRST ARG73_2_5 :
    MATCH "0" -> GOTO ARG73_3_5;
STATE USEFIRST ARG73_3_5 :
    MATCH "(void) sizeof ((\n# 64 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound1_process_dc_iter1.c\"\n       0 && \"6*a*x - x*z + 12*x == 0\"\n# 64 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound1_process_dc_iter1.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG73_4_5;
STATE USEFIRST ARG73_4_5 :
    MATCH "0 && \"6*a*x - x*z + 12*x == 0\"" -> GOTO ARG73;
    TRUE -> STOP;

STATE USEFIRST ARG73 :
    MATCH "__assert_fail (\n# 64 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound1_process_dc_iter1.c\"\n       \"0 && \\\"6*a*x - x*z + 12*x == 0\\\"\"\n# 64 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound1_process_dc_iter1.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound1_process_dc_iter1.c\", 64, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
