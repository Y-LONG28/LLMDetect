...
int main_0() {
  ...
  __assert_fail("0 && \"Assertion failed: local_14 should not equal 6\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/nested_1b_process_dc_iter1.c", 17, "__PRETTY_FUNCTION__");
}
