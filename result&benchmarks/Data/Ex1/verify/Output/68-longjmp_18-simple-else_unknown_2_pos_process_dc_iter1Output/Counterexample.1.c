...
int main_0() {
  ...
  __CPROVER_assume(global != 2);
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: global == 2\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_18-simple-else_unknown_2_pos_process_dc_iter1.c", 33, "__PRETTY_FUNCTION__");
}
