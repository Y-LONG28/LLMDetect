...
int main_0() {
  ...
  __CPROVER_assume(!(p != (((ulonglong )local_3c) * q)));
  __CPROVER_assume(!(d < p));
  p = p << 1;
  q = q << 1;
  iVar2 = counter + 1;
  bVar1 = counter < 2;
  ...
  __CPROVER_assume(!(((ulonglong )tmp_var_2_uint) != (d + (p * A))));
  __CPROVER_assume(p != ((ulonglong )local_3c));
  int __CPAchecker_TMP_9;
  __CPAchecker_TMP_9 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: B == d\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/hard-ll_unwindbound2_process_dc_iter1.c", 53, "__PRETTY_FUNCTION__");
}
