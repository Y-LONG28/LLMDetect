...
int main_0() {
  ...
  n = 0;
  __CPROVER_assume(local_20 != 2147483647);
  sn = 1;
  __CPROVER_assume(sn <= local_20);
  __CPROVER_assume(sn < ((int)expr_tmp_var_20_uint));
  n = n + 2;
  ...
  sn = sn + 1;
  __CPROVER_assume(!(sn <= local_20));
  __CPROVER_assume(((long)n) != (((long)local_20) << 1));
  __CPROVER_assume(n != 0);
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: sn==((long long) n)*a || sn == 0\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/sum01_bug02_process_dc_iter1.c", 32, "__PRETTY_FUNCTION__");
}
