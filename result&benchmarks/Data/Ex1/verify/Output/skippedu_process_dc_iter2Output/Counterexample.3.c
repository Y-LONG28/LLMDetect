...
struct __anon_type_max_align_t {
  long long __max_align_ll;
  long double __max_align_ld;
} ;
typedef struct __anon_type_max_align_t max_align_t;
...
int main_0() {
  ...
  int i;
  SIZE = (int)((size_t )a);
  __CPROVER_assume(1 < ((int)((size_t )a)));
  __CPROVER_assume(((int)((size_t )a)) < 100000);
  pvVar1 = malloc((long)(((int)((size_t )a)) * 4));
  i = 0;
  __CPROVER_assume(i < SIZE);
  *((uint32_t *)((((long)i) * 4) + ((long)pvVar1))) = local_24;
  i = i + 1;
  __CPROVER_assume(i < SIZE);
  *((uint32_t *)((((long)i) * 4) + ((long)pvVar1))) = local_24;
  i = i + 1;
  __CPROVER_assume(!(i < SIZE));
  __CPROVER_assume((SIZE & 1U) == 0);
  assume_1((uint )((SIZE & 1U) == 0));
  i = 1;
  __CPROVER_assume(i <= (SIZE / 2));
  __CPROVER_assume(!(i < (*((int *)(((((long)(i * 2)) * 4) + -8) + ((long)pvVar1))))));
  __CPROVER_assume(!(i < (*((int *)(((((long)(i * 2)) * 4) + -4) + ((long)pvVar1))))));
  i = i + 1;
  __CPROVER_assume(!(i <= (SIZE / 2)));
  i = 0;
  __CPROVER_assume(i < SIZE);
  __CPROVER_assume(i < (*((int *)((((long)i) * 4) + ((long)pvVar1)))));
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"a[i] <= i\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/skippedu_process_dc_iter2.c", 40, "__PRETTY_FUNCTION__");
}
