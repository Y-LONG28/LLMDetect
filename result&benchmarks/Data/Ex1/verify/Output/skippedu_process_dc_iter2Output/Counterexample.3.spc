...
STATE USEFIRST ARG25_295_1 :
    MATCH "typedef long int ptrdiff_t;" -> GOTO ARG25_296_1;
STATE USEFIRST ARG25_296_1 :
    MATCH "typedef struct {\n  long long __max_align_ll __attribute__((__aligned__(__alignof__(long long))));\n  long double __max_align_ld __attribute__((__aligned__(__alignof__(long double))));\n# 426 \"/usr/lib/gcc/x86_64-linux-gnu/11/include/stddef.h\" 3 4\n} max_align_t;" -> GOTO ARG25_297_1;
STATE USEFIRST ARG25_297_1 :
    MATCH "typedef struct {\n  long long __max_align_ll __attribute__((__aligned__(__alignof__(long long))));\n  long double __max_align_ld __attribute__((__aligned__(__alignof__(long double))));\n# 426 \"/usr/lib/gcc/x86_64-linux-gnu/11/include/stddef.h\" 3 4\n} max_align_t;" -> GOTO ARG25_298_1;
STATE USEFIRST ARG25_298_1 :
    MATCH "void assume(int cond)" -> GOTO ARG25_299_1;
STATE USEFIRST ARG25_299_1 :
    MATCH "int SIZE;" -> GOTO ARG25_300_1;
STATE USEFIRST ARG25_300_1 :
    MATCH "int main(void)" -> GOTO ARG25_301_1;
STATE USEFIRST ARG25_301_1 :
    MATCH "" -> GOTO ARG25_302_1;
STATE USEFIRST ARG25_302_1 :
    MATCH "void *pvVar1;" -> GOTO ARG25_303_1;
STATE USEFIRST ARG25_303_1 :
    MATCH "uint32_t local_24;" -> GOTO ARG25_304_1;
STATE USEFIRST ARG25_304_1 :
    MATCH "int *a;" -> GOTO ARG25_305_1;
STATE USEFIRST ARG25_305_1 :
    MATCH "int i;" -> GOTO ARG25_306_1;
STATE USEFIRST ARG25_306_1 :
    MATCH "SIZE = (int)(size_t)a;" -> GOTO ARG25;
    TRUE -> STOP;

STATE USEFIRST ARG25 :
    MATCH "[(1 < (int)(size_t)a) && ((int)(size_t)a < 100000)]" -> GOTO ARG59;
    TRUE -> STOP;

STATE USEFIRST ARG59 :
    MATCH "[(1 < (int)(size_t)a) && ((int)(size_t)a < 100000)]" -> GOTO ARG61;
    TRUE -> STOP;

STATE USEFIRST ARG61 :
    MATCH "pvVar1 = malloc((long)((int)(size_t)a * 4));" -> GOTO ARG64_1_2;
STATE USEFIRST ARG64_0_2 :
    MATCH "pvVar1 = malloc((long)((int)(size_t)a * 4));" -> GOTO ARG64_1_2;
STATE USEFIRST ARG64_1_2 :
    MATCH "" -> GOTO ARG64;
    TRUE -> STOP;

STATE USEFIRST ARG64 :
    MATCH "i = 0" -> ASSUME {i == (0);} GOTO ARG66;
    TRUE -> STOP;

STATE USEFIRST ARG66 :
    MATCH "[i < SIZE]" -> ASSUME {i == (0);} GOTO ARG85;
    TRUE -> STOP;

STATE USEFIRST ARG85 :
    MATCH "*(uint32_t *)((long)i * 4 + (long)pvVar1) = local_24;" -> GOTO ARG87_1_3;
...
STATE USEFIRST ARG87 :
    MATCH "i = i + 1" -> ASSUME {i == (1);} GOTO ARG91;
    TRUE -> STOP;

STATE USEFIRST ARG91 :
    MATCH "[i < SIZE]" -> ASSUME {i == (1);} GOTO ARG105;
    TRUE -> STOP;

STATE USEFIRST ARG105 :
    MATCH "*(uint32_t *)((long)i * 4 + (long)pvVar1) = local_24;" -> GOTO ARG108_1_4;
...
STATE USEFIRST ARG108 :
    MATCH "i = i + 1" -> ASSUME {i == (2);} GOTO ARG110;
    TRUE -> STOP;

STATE USEFIRST ARG110 :
    MATCH "[!(i < SIZE)]" -> ASSUME {i == (2);} GOTO ARG131;
    TRUE -> STOP;

STATE USEFIRST ARG131 :
    MATCH "[(SIZE & 1U) == 0]" -> GOTO ARG154;
    TRUE -> STOP;

STATE USEFIRST ARG154 :
    MATCH "assume((uint)((SIZE & 1U) == 0));" -> GOTO ARG160;
    TRUE -> STOP;
...
STATE USEFIRST ARG650 :
    MATCH "i = 1" -> ASSUME {i == (1);} GOTO ARG662;
    TRUE -> STOP;

STATE USEFIRST ARG662 :
    MATCH "[i <= SIZE / 2]" -> ASSUME {i == (1);} GOTO ARG735;
    TRUE -> STOP;

STATE USEFIRST ARG735 :
    MATCH "[!(i < *(int *)((long)(i * 2) * 4 + -8 + (long)pvVar1))]" -> ASSUME {i == (1);} GOTO ARG802;
    TRUE -> STOP;

STATE USEFIRST ARG802 :
    MATCH "[!(i < *(int *)((long)(i * 2) * 4 + -4 + (long)pvVar1))]" -> ASSUME {i == (1);} GOTO ARG820;
    TRUE -> STOP;
...
STATE USEFIRST ARG831 :
    MATCH "i = i + 1" -> ASSUME {i == (2);} GOTO ARG875;
    TRUE -> STOP;

STATE USEFIRST ARG875 :
    MATCH "[!(i <= SIZE / 2)]" -> ASSUME {i == (2);} GOTO ARG900;
    TRUE -> STOP;
...
STATE USEFIRST ARG940 :
    MATCH "i = 0" -> ASSUME {i == (0);} GOTO ARG975;
    TRUE -> STOP;

STATE USEFIRST ARG975 :
    MATCH "[i < SIZE]" -> ASSUME {i == (0);} GOTO ARG990;
    TRUE -> STOP;

STATE USEFIRST ARG990 :
    MATCH "[i < *(int *)((long)i * 4 + (long)pvVar1)]" -> ASSUME {i == (0);} GOTO ARG1013;
    TRUE -> STOP;

STATE USEFIRST ARG1013 :
    MATCH "(void) sizeof ((\n# 40 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/skippedu_process_dc_iter2.c\"\n                   0 && \"a[i] <= i\"\n# 40 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/skippedu_process_dc_iter2.c\" 3 4\n                   ) ? 1 : 0)" -> GOTO ARG1066_1_5;
STATE USEFIRST ARG1066_0_5 :
    MATCH "(void) sizeof ((\n# 40 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/skippedu_process_dc_iter2.c\"\n                   0 && \"a[i] <= i\"\n# 40 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/skippedu_process_dc_iter2.c\" 3 4\n                   ) ? 1 : 0)" -> GOTO ARG1066_1_5;
STATE USEFIRST ARG1066_1_5 :
    MATCH "(\n# 40 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/skippedu_process_dc_iter2.c\"\n                   0 && \"a[i] <= i\"\n# 40 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/skippedu_process_dc_iter2.c\" 3 4\n                   )" -> GOTO ARG1066_2_5;
STATE USEFIRST ARG1066_2_5 :
    MATCH "0" -> GOTO ARG1066_3_5;
STATE USEFIRST ARG1066_3_5 :
    MATCH "(void) sizeof ((\n# 40 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/skippedu_process_dc_iter2.c\"\n                   0 && \"a[i] <= i\"\n# 40 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/skippedu_process_dc_iter2.c\" 3 4\n                   ) ? 1 : 0)" -> GOTO ARG1066_4_5;
STATE USEFIRST ARG1066_4_5 :
    MATCH "0 && \"a[i] <= i\"" -> GOTO ARG1066;
    TRUE -> STOP;

STATE USEFIRST ARG1066 :
    MATCH "__assert_fail (\n# 40 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/skippedu_process_dc_iter2.c\"\n                   \"0 && \\\"a[i] <= i\\\"\"\n# 40 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/skippedu_process_dc_iter2.c\" 3 4\n                   , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/skippedu_process_dc_iter2.c\", 40, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
