...
int main_0() {
  ...
  __CPROVER_assume(!(expr_tmp_var_53_int != 0));
  expr_tmp_var_52_ptr = x;
  ...
  x = pSVar1;
  expr_tmp_var_52_ptr = x;
  __CPROVER_assume(!((expr_tmp_var_52_ptr->data) != 1));
  expr_tmp_var_52_ptr = (SLL *)(expr_tmp_var_52_ptr->next);
  __CPROVER_assume(expr_tmp_var_52_ptr != ((TSLL *)0));
  __CPROVER_assume((expr_tmp_var_52_ptr->data) != 1);
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: expr_tmp_var_52_ptr->data != 1\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/sll-simple-white-blue-2_process_dc_iter2.c", 63, "__PRETTY_FUNCTION__");
}
