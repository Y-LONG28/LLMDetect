...
int main_0() {
  ...
  SORT_1 mask_SORT_1;
  SORT_1 state_3;
  expr_tmp_var_6_uchar = '\x0';
  __CPROVER_assume(!(expr_tmp_var_6_uchar == '\x7'));
  ...
  __assert_fail("0 && \"Assertion failed: !(bad_11_arg_0)\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/btor2c-lazyMod.count2_process_dc_iter1.c", 41, "__PRETTY_FUNCTION__");
}
