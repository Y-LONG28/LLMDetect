...
STATE USEFIRST ARG296 :
    MATCH "int a;" -> ASSUME {a == (0);} GOTO ARG297;
    TRUE -> STOP;

STATE USEFIRST ARG297 :
    MATCH "int b;" -> ASSUME {b == (0);} GOTO ARG298;
    TRUE -> STOP;

STATE USEFIRST ARG298 :
    MATCH "int *p1;" -> ASSUME {p1 == (0LL);} GOTO ARG299;
    TRUE -> STOP;

STATE USEFIRST ARG299 :
    MATCH "int *p2;" -> ASSUME {p2 == (0LL);} GOTO ARG300;
    TRUE -> STOP;

STATE USEFIRST ARG300 :
    MATCH "int f(void);" -> GOTO ARG301;
    TRUE -> STOP;
...
STATE USEFIRST ARG304 :
    MATCH "int iVar1;" -> GOTO ARG305;
    TRUE -> STOP;

STATE USEFIRST ARG305 :
    MATCH "p1 = &a;" -> ASSUME {p1 == (8LL);} GOTO ARG306;
    TRUE -> STOP;

STATE USEFIRST ARG306 :
    MATCH "p2 = &b;" -> ASSUME {p2 == (28LL);} GOTO ARG307;
    TRUE -> STOP;

STATE USEFIRST ARG307 :
    MATCH "b = 1;" -> ASSUME {b == (1);} GOTO ARG308;
    TRUE -> STOP;

STATE USEFIRST ARG308 :
    MATCH "a = 4;" -> ASSUME {a == (4);} GOTO ARG309;
    TRUE -> STOP;

STATE USEFIRST ARG309 :
    MATCH "a = f();" -> GOTO ARG310;
    TRUE -> STOP;
...
STATE USEFIRST ARG311 :
    MATCH "_Bool \n# 22 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test08_process_dc_iter2.c\"\n      bVar1;" -> GOTO ARG312;
    TRUE -> STOP;

STATE USEFIRST ARG312 :
    MATCH "bVar1 = (*p2 + *p1) - a == 1;" -> ASSUME {bVar1 == (1);} GOTO ARG313;
    TRUE -> STOP;

STATE USEFIRST ARG313 :
    MATCH "[bVar1]" -> ASSUME {bVar1 == (1);} GOTO ARG315;
    MATCH "[!(bVar1)]" -> GOTO ARG318;
    TRUE -> STOP;

STATE USEFIRST ARG315 :
    MATCH "p1 = p2;" -> ASSUME {p1 == (28LL);(*(p1)) == (1);} GOTO ARG316;
    TRUE -> STOP;
...
STATE USEFIRST ARG318 :
    MATCH "return (int)bVar1;" -> GOTO ARG319;
    TRUE -> STOP;
...
STATE USEFIRST ARG320 :
    MATCH "[!((a == 0) || (p1 != p2))]" -> ASSUME {a == (1);} GOTO ARG322;
    TRUE -> STOP;

STATE USEFIRST ARG322 :
    MATCH "[!((a == 0) || (p1 != p2))]" -> ASSUME {p1 == (28LL);(*(p1)) == (1);p2 == (28LL);(*(p2)) == (1);} GOTO ARG324;
    TRUE -> STOP;

STATE USEFIRST ARG324 :
    MATCH "iVar1 = 0x100000;" -> GOTO ARG326;
    TRUE -> STOP;
...
STATE USEFIRST ARG330 :
    MATCH "0 && \"Assertion failed: main\"" -> GOTO ARG331;
    TRUE -> STOP;

STATE USEFIRST ARG331 :
    MATCH "__assert_fail (\n# 43 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test08_process_dc_iter2.c\"\n   \"0 && \\\"Assertion failed: main\\\"\"\n# 43 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test08_process_dc_iter2.c\" 3 4\n   , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test08_process_dc_iter2.c\", 43, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
