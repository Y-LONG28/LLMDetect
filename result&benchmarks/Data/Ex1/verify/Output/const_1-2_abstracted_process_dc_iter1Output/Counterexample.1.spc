...
STATE USEFIRST ARG296 :
    MATCH "typedef long long longlong;" -> GOTO ARG297;
    TRUE -> STOP;

STATE USEFIRST ARG297 :
    MATCH "void assume(int cond)" -> GOTO ARG298;
    TRUE -> STOP;

STATE USEFIRST ARG298 :
    MATCH "int main(void)" -> GOTO ARG299;
    TRUE -> STOP;

STATE USEFIRST ARG299 :
    MATCH "void __assert_func(const char *file, int line, const char *func, const char *msg)" -> GOTO ARG300;
    TRUE -> STOP;
...
STATE USEFIRST ARG301 :
    MATCH "uint y__VERIFIER_LA_old_tmp0;" -> GOTO ARG302;
    TRUE -> STOP;

STATE USEFIRST ARG302 :
    MATCH "uint x__VERIFIER_LA_old_tmp0;" -> GOTO ARG303;
    TRUE -> STOP;

STATE USEFIRST ARG303 :
    MATCH "longlong __VERIFIER_LA_iterations0;" -> GOTO ARG304;
    TRUE -> STOP;

STATE USEFIRST ARG304 :
    MATCH "longlong y__VERIFIER_LA_tmp0;" -> GOTO ARG305;
    TRUE -> STOP;

STATE USEFIRST ARG305 :
    MATCH "uint y;" -> GOTO ARG306;
    TRUE -> STOP;

STATE USEFIRST ARG306 :
    MATCH "uint x;" -> ASSUME {x == (0U);} GOTO ARG307;
    TRUE -> STOP;

STATE USEFIRST ARG307 :
    MATCH "(void) sizeof ((\n# 23 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/const_1-2_abstracted_process_dc_iter1.c\"\n   x == 1 && \"Assertion failed: x should be equal to 1\"\n# 23 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/const_1-2_abstracted_process_dc_iter1.c\" 3 4\n   ) ? 1 : 0)" -> GOTO ARG308;
    TRUE -> STOP;

STATE USEFIRST ARG308 :
    MATCH "[!((\n# 23 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/const_1-2_abstracted_process_dc_iter1.c\"\n   x == 1 && \"Assertion failed: x should be equal to 1\"\n# 23 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/const_1-2_abstracted_process_dc_iter1.c\" 3 4\n   ))]" -> ASSUME {x == (0U);} GOTO ARG313;
    TRUE -> STOP;
...
STATE USEFIRST ARG317 :
    MATCH "[!(x == 1 && \"Assertion failed: x should be equal to 1\")]" -> ASSUME {x == (0U);} GOTO ARG322;
    TRUE -> STOP;

STATE USEFIRST ARG322 :
    MATCH "__assert_fail (\n# 23 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/const_1-2_abstracted_process_dc_iter1.c\"\n   \"x == 1 && \\\"Assertion failed: x should be equal to 1\\\"\"\n# 23 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/const_1-2_abstracted_process_dc_iter1.c\" 3 4\n   , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/const_1-2_abstracted_process_dc_iter1.c\", 23, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
