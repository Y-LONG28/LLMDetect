...
int main_0() {
  ...
  __assert_fail("0 && \"Assertion failed: iVar1 should not equal 0x14\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/id_i20_o20-2_process_dc_iter1.c", 35, "__PRETTY_FUNCTION__");
}
