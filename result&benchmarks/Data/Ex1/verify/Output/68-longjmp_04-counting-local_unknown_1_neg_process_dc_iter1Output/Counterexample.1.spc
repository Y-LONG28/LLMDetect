...
STATE USEFIRST ARG282 :
    MATCH "jmp_buf my_jump_buffer;" -> GOTO ARG283;
    TRUE -> STOP;

STATE USEFIRST ARG283 :
    MATCH "void foo(int count)" -> GOTO ARG284;
    TRUE -> STOP;

STATE USEFIRST ARG284 :
    MATCH "int main(void)" -> GOTO ARG285;
    TRUE -> STOP;

STATE USEFIRST ARG285 :
    MATCH "void longjmp(jmp_buf env, int val)" -> GOTO ARG286;
    TRUE -> STOP;

STATE USEFIRST ARG286 :
    MATCH "int _setjmp (\n# 31 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\"\n   jmp_buf env\n# 31 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\" 3 4\n   )" -> GOTO ARG287;
    TRUE -> STOP;

STATE USEFIRST ARG287 :
    MATCH "void __assert_func(const char *file, int line, const char *func, const char *failedexpr)" -> GOTO ARG288;
    TRUE -> STOP;
...
STATE USEFIRST ARG289 :
    MATCH "int count;" -> ASSUME {count == (0);} GOTO ARG290;
    TRUE -> STOP;

STATE USEFIRST ARG290 :
    MATCH "_setjmp (\n# 17 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\"\n       my_jump_buffer\n# 17 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\" 3 4\n       ) \n# 17 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\"\n                              == 0" -> GOTO ARG291;
    TRUE -> STOP;
...
STATE USEFIRST ARG295 :
    MATCH "[_setjmp (\n# 17 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\"\n       my_jump_buffer\n# 17 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\" 3 4\n       ) \n# 17 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\"\n                              == 0]" -> ASSUME {__CPAchecker_TMP_0 == (0);} GOTO ARG296;
    TRUE -> STOP;

STATE USEFIRST ARG296 :
    MATCH "(void) sizeof ((\n# 18 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\"\n       count != 0 && \"Assertion failed: count should not be 0\"\n# 18 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG298;
    TRUE -> STOP;

STATE USEFIRST ARG298 :
    MATCH "[!((\n# 18 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\"\n       count != 0 && \"Assertion failed: count should not be 0\"\n# 18 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\" 3 4\n       ))]" -> ASSUME {count == (0);} GOTO ARG303;
    TRUE -> STOP;
...
STATE USEFIRST ARG307 :
    MATCH "[!(count != 0 && \"Assertion failed: count should not be 0\")]" -> ASSUME {count == (0);} GOTO ARG312;
    TRUE -> STOP;

STATE USEFIRST ARG312 :
    MATCH "__assert_fail (\n# 18 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\"\n       \"count != 0 && \\\"Assertion failed: count should not be 0\\\"\"\n# 18 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_04-counting-local_unknown_1_neg_process_dc_iter1.c\", 18, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
