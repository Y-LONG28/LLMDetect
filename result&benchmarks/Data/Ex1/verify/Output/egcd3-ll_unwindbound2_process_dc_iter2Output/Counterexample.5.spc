...
STATE USEFIRST ARG7_300_1 :
    MATCH "_Bool \n# 16 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c\"\n        bVar1;" -> GOTO ARG7_301_1;
...
STATE USEFIRST ARG7 :
    MATCH "assume((uint)(0 < tmp_var_2_int));" -> GOTO ARG10;
    TRUE -> STOP;
...
STATE USEFIRST ARG46 :
    MATCH "assume((uint)(0 < temp));" -> GOTO ARG47;
    TRUE -> STOP;
...
STATE USEFIRST ARG52 :
    MATCH "b = (longlong)tmp_var_2_int;" -> GOTO ARG53_1_2;
STATE USEFIRST ARG53_0_2 :
    MATCH "b = (longlong)tmp_var_2_int;" -> GOTO ARG53_1_2;
STATE USEFIRST ARG53_1_2 :
    MATCH "p = (longlong)temp;" -> GOTO ARG53_2_2;
STATE USEFIRST ARG53_2_2 :
    MATCH "q = 1;" -> GOTO ARG53_3_2;
STATE USEFIRST ARG53_3_2 :
    MATCH "r = 0;" -> GOTO ARG53_4_2;
STATE USEFIRST ARG53_4_2 :
    MATCH "s = 0;" -> GOTO ARG53_5_2;
STATE USEFIRST ARG53_5_2 :
    MATCH "c = 1;" -> ASSUME {q == (1LL);r == (0LL);s == (0LL);c == (1LL);} GOTO ARG53;
    TRUE -> STOP;
...
STATE USEFIRST ARG54 :
    MATCH "lVar4 = q;" -> GOTO ARG64_1_3;
STATE USEFIRST ARG64_0_3 :
    MATCH "lVar4 = q;" -> GOTO ARG64_1_3;
STATE USEFIRST ARG64_1_3 :
    MATCH "lVar3 = s;" -> GOTO ARG64_2_3;
STATE USEFIRST ARG64_2_3 :
    MATCH "iVar2 = counter + 1;" -> ASSUME {lVar4 == (1LL);lVar3 == (0LL);iVar2 == (1);} GOTO ARG64;
    TRUE -> STOP;

STATE USEFIRST ARG64 :
    MATCH "[!((1 < counter) || (p == 0))]" -> ASSUME {counter == (0);} GOTO ARG76;
    TRUE -> STOP;

STATE USEFIRST ARG76 :
    MATCH "[!((1 < counter) || (p == 0))]" -> GOTO ARG95;
    TRUE -> STOP;

STATE USEFIRST ARG95 :
    MATCH "d = 0;" -> GOTO ARG100_1_4;
STATE USEFIRST ARG100_0_4 :
    MATCH "d = 0;" -> GOTO ARG100_1_4;
STATE USEFIRST ARG100_1_4 :
    MATCH "counter = iVar2;" -> GOTO ARG100_2_4;
STATE USEFIRST ARG100_2_4 :
    MATCH "" -> GOTO ARG100;
    TRUE -> STOP;

STATE USEFIRST ARG100 :
    MATCH "k = b" -> GOTO ARG101;
    TRUE -> STOP;

STATE USEFIRST ARG101 :
    MATCH "[(counter < 2 && (p <= k))]" -> ASSUME {counter == (1);} GOTO ARG106;
    TRUE -> STOP;

STATE USEFIRST ARG106 :
    MATCH "[!((counter < 2 && (p <= k)))]" -> GOTO ARG256;
    TRUE -> STOP;

STATE USEFIRST ARG256 :
    MATCH "b = p;" -> GOTO ARG300_1_5;
STATE USEFIRST ARG300_0_5 :
    MATCH "b = p;" -> GOTO ARG300_1_5;
STATE USEFIRST ARG300_1_5 :
    MATCH "p = k;" -> GOTO ARG300_2_5;
STATE USEFIRST ARG300_2_5 :
    MATCH "q = r;" -> GOTO ARG300_3_5;
STATE USEFIRST ARG300_3_5 :
    MATCH "r = lVar4 - r * d;" -> GOTO ARG300_4_5;
STATE USEFIRST ARG300_4_5 :
    MATCH "s = c;" -> GOTO ARG300_5_5;
STATE USEFIRST ARG300_5_5 :
    MATCH "c = lVar3 - c * d;" -> GOTO ARG300_6_5;
STATE USEFIRST ARG300_6_5 :
    MATCH "counter = counter + 1;" -> GOTO ARG300_7_5;
STATE USEFIRST ARG300_7_5 :
    MATCH "" -> GOTO ARG300_8_5;
STATE USEFIRST ARG300_8_5 :
    MATCH "1" -> GOTO ARG300;
    TRUE -> STOP;
...
STATE USEFIRST ARG304 :
    MATCH "lVar4 = q;" -> GOTO ARG400_1_6;
STATE USEFIRST ARG400_0_6 :
    MATCH "lVar4 = q;" -> GOTO ARG400_1_6;
STATE USEFIRST ARG400_1_6 :
    MATCH "lVar3 = s;" -> GOTO ARG400_2_6;
STATE USEFIRST ARG400_2_6 :
    MATCH "iVar2 = counter + 1;" -> ASSUME {lVar4 == (0LL);lVar3 == (1LL);iVar2 == (3);} GOTO ARG400;
    TRUE -> STOP;

STATE USEFIRST ARG400 :
    MATCH "[(1 < counter) || (p == 0)]" -> ASSUME {counter == (2);} GOTO ARG416;
    TRUE -> STOP;

STATE USEFIRST ARG416 :
    MATCH "counter = iVar2;" -> ASSUME {counter == (3);} GOTO ARG421;
    TRUE -> STOP;

STATE USEFIRST ARG421 :
    MATCH "[b != ((tmp_var_2_int * q - tmp_var_2_int * r) + temp * s) - temp * c]" -> GOTO ARG624;
    TRUE -> STOP;

STATE USEFIRST ARG624 :
    MATCH "(void) sizeof ((\n# 50 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c\"\n               0 && \"Assertion failed: p*x - q*x + r*y - s*y == a\"\n# 50 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c\" 3 4\n               ) ? 1 : 0)" -> GOTO ARG635_1_7;
STATE USEFIRST ARG635_0_7 :
    MATCH "(void) sizeof ((\n# 50 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c\"\n               0 && \"Assertion failed: p*x - q*x + r*y - s*y == a\"\n# 50 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c\" 3 4\n               ) ? 1 : 0)" -> GOTO ARG635_1_7;
STATE USEFIRST ARG635_1_7 :
    MATCH "(\n# 50 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c\"\n               0 && \"Assertion failed: p*x - q*x + r*y - s*y == a\"\n# 50 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c\" 3 4\n               )" -> GOTO ARG635_2_7;
STATE USEFIRST ARG635_2_7 :
    MATCH "0" -> GOTO ARG635_3_7;
STATE USEFIRST ARG635_3_7 :
    MATCH "(void) sizeof ((\n# 50 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c\"\n               0 && \"Assertion failed: p*x - q*x + r*y - s*y == a\"\n# 50 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c\" 3 4\n               ) ? 1 : 0)" -> GOTO ARG635_4_7;
STATE USEFIRST ARG635_4_7 :
    MATCH "0 && \"Assertion failed: p*x - q*x + r*y - s*y == a\"" -> GOTO ARG635;
    TRUE -> STOP;

STATE USEFIRST ARG635 :
    MATCH "__assert_fail (\n# 50 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c\"\n               \"0 && \\\"Assertion failed: p*x - q*x + r*y - s*y == a\\\"\"\n# 50 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c\" 3 4\n               , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c\", 50, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
