...
int main_0() {
  ...
  lVar3 = s;
  iVar2 = counter + 1;
  __CPROVER_assume(!(1 < counter));
  __CPROVER_assume(!(p == 0));
  d = 0;
  counter = iVar2;
  k = b;
  __CPROVER_assume(counter < 2);
  __CPROVER_assume(!(p <= k));
  b = p;
  p = k;
  q = r;
  r = lVar4 - (r * d);
  ...
  __CPROVER_assume(1 < counter);
  counter = iVar2;
  __CPROVER_assume(b != ((((tmp_var_2_int * q) - (tmp_var_2_int * r)) + (temp * s)) - (temp * c)));
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: p*x - q*x + r*y - s*y == a\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound2_process_dc_iter2.c", 50, "__PRETTY_FUNCTION__");
}
