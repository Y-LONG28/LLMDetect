...
int main_0();
int addition_1(int m, int n);
int addition_2(int m, int n);
int main_0() {
  int iVar1;
  int local_18;
  int result;
  ...
  __CPROVER_assume(!(1073741823 < result));
  __CPROVER_assume(!(local_18 < 0));
  __CPROVER_assume(!(1073741823 < local_18));
  iVar1 = addition_1(result, local_18);
  __CPROVER_assume(!(iVar1 == (result - local_18)));
  iVar1 = 1048576;
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: iVar1 should not equal result - local_18\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/Addition02_process_dc_iter1.c", 49, "__PRETTY_FUNCTION__");
}
