...
int main_0() {
  ...
  uint q;
  uint p;
  assume_1((uint )(local_24 < 1073741823));
  r = 0;
  ...
  __CPROVER_assume(!(bVar1 == 0));
  __CPROVER_assume(h <= local_24);
  __CPAchecker_TMP_1 = 1;
  __CPAchecker_TMP_0 = __CPAchecker_TMP_1;
  ...
  __CPAchecker_TMP_0 = __CPAchecker_TMP_1;
  __CPROVER_assume(__CPAchecker_TMP_0 == 0);
  _Bool __CPAchecker_TMP_2;
  iVar2 = counter + 1;
  bVar1 = counter < 5;
  counter = iVar2;
  __CPAchecker_TMP_2 = bVar1;
  __CPROVER_assume(!(__CPAchecker_TMP_2 == 0));
  __CPROVER_assume(!(((r * 2) + h) <= tmp_var_1_uint));
  __CPROVER_assume(!(((tmp_var_1_uint * h) + (r * r)) != (local_24 * h)));
  __CPROVER_assume(!((((((((((tmp_var_1_uint * n) * h) * 3) - ((h * r) * h)) * 4) - ((h * n) * h)) + (((h * local_24) * r) * 16)) + ((n * n) * n)) + (((h * n) * local_24) * -12)) != (((tmp_var_1_uint * r) * h) * 16)));
  __CPROVER_assume(!((((((((tmp_var_1_uint * h) * tmp_var_1_uint) * 4) + ((tmp_var_1_uint * h) * h)) + (((tmp_var_1_uint * local_24) * h) * -8)) + ((((tmp_var_1_uint * n) * r) * 4) - ((tmp_var_1_uint * n) * n))) + ((((((h * local_24) * local_24) * 4) + ((local_24 * n) * n)) + (((r * n) * local_24) * -4)) - ((h * local_24) * h))) != 0));
  __CPROVER_assume(!((((((((tmp_var_1_uint * n) * h) * 4) - ((h * r) * h)) + (((h * local_24) * r) * 4)) + ((r * n) * n)) + (((h * n) * local_24) * -4)) != (((tmp_var_1_uint * r) * h) * 4)));
  __CPROVER_assume(!(((h * tmp_var_1_uint) + ((r * r) - (local_24 * h))) != 0));
  __CPROVER_assume(!(h == 1));
  h = h >> 2;
  n = h + r;
  r = r >> 1;
  __CPROVER_assume(n <= tmp_var_1_uint);
  r = h + r;
  ...
  __CPAchecker_TMP_2 = bVar1;
  __CPROVER_assume(__CPAchecker_TMP_2 == 0);
  __CPROVER_assume((((((((local_24 * r) * 16) + ((n * tmp_var_1_uint) * 12)) + ((n * n) * n)) + ((n * local_24) * -12)) + ((r * tmp_var_1_uint) * -16)) - n) != (r * 4));
  int __CPAchecker_TMP_23;
  __CPAchecker_TMP_23 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"h*h*h - 12*h*n + 16*n*p + 12*h*r - 16*p*r - h - 4*p == 0\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/dijkstra-u_unwindbound5_process_dc_iter1.c", 73, "__PRETTY_FUNCTION__");
}
