...
int main_0() {
  ...
  long long x;
  long long y;
  assume_1((unsigned int)(local_2a < 257));
  x = 0;
  c = 0;
  lStack_28 = 0;
  ...
  __assert_fail("0 && \"k*y == y*y\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/ps6-ll_unwindbound1_process_dc_iter1.c", 47, "__PRETTY_FUNCTION__");
}
