...
int main_0();
int f_1(int a, int **p1, int **p2);
void g_2(int **p1, int **p2);
int main_0() {
  int iVar1;
  int **local_28;
  int *p2;
  ...
  *((int *)(&p1)) = 1;
  *((int *)(((long)(&p1)) + 4)) = 4;
  *((int *)(((long)(&p1)) + 4)) = f_1(4, &p2, (int **)(&local_28));
  ...
  __assert_fail("0 && \"Assertion failed: *p2 should not be 0\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test06_process_dc_iter1.c", 50, "__PRETTY_FUNCTION__");
}
