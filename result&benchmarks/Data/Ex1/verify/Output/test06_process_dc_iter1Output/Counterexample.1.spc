...
STATE USEFIRST ARG272 :
    MATCH "void assume(int cond)" -> GOTO ARG273;
    TRUE -> STOP;

STATE USEFIRST ARG273 :
    MATCH "void g(int **p1, int **p2)" -> GOTO ARG274;
    TRUE -> STOP;

STATE USEFIRST ARG274 :
    MATCH "int f(int a, int **p1, int **p2)" -> GOTO ARG275;
    TRUE -> STOP;

STATE USEFIRST ARG275 :
    MATCH "int main(void)" -> GOTO ARG276;
    TRUE -> STOP;
...
STATE USEFIRST ARG277 :
    MATCH "int iVar1;" -> GOTO ARG278;
    TRUE -> STOP;

STATE USEFIRST ARG278 :
    MATCH "int **local_28;" -> GOTO ARG279;
    TRUE -> STOP;

STATE USEFIRST ARG279 :
    MATCH "int *p2;" -> GOTO ARG280;
    TRUE -> STOP;

STATE USEFIRST ARG280 :
    MATCH "int *p1;" -> ASSUME {p1 == (0LL);} GOTO ARG281;
    TRUE -> STOP;

STATE USEFIRST ARG281 :
    MATCH "int b;" -> GOTO ARG282;
    TRUE -> STOP;

STATE USEFIRST ARG282 :
    MATCH "int a;" -> GOTO ARG283;
    TRUE -> STOP;

STATE USEFIRST ARG283 :
    MATCH "p2 = (int *)((long)&p1 + 4);" -> ASSUME {p2 == (44LL);} GOTO ARG284;
    TRUE -> STOP;

STATE USEFIRST ARG284 :
    MATCH "local_28 = &p1;" -> ASSUME {local_28 == (40LL);} GOTO ARG285;
    TRUE -> STOP;

STATE USEFIRST ARG285 :
    MATCH "*(int *)&p1 = 1;" -> ASSUME {(*((int *)(&p1))) == (1);} GOTO ARG286;
    TRUE -> STOP;

STATE USEFIRST ARG286 :
    MATCH "*(int *)((long)&p1 + 4) = 4;" -> ASSUME {(*((int *)(((long)(&p1)) + (4)))) == (4);} GOTO ARG287;
    TRUE -> STOP;

STATE USEFIRST ARG287 :
    MATCH "*(int *)((long)&p1 + 4) = f(4, &p2, (int **)&local_28);" -> GOTO ARG288;
    TRUE -> STOP;

STATE USEFIRST ARG288 :
    MATCH "" -> ASSUME {a == (4);p1 == (28LL);(*(p1)) == (44LL);(*(*(p1))) == (4);p2 == (8LL);} GOTO ARG289;
    TRUE -> STOP;

STATE USEFIRST ARG289 :
    MATCH "int **p2_local;" -> ASSUME {a == (4);p1 == (28LL);(*(p1)) == (44LL);(*(*(p1))) == (4);p2 == (8LL);} GOTO ARG290;
    TRUE -> STOP;

STATE USEFIRST ARG290 :
    MATCH "int **p1_local;" -> GOTO ARG291;
    TRUE -> STOP;

STATE USEFIRST ARG291 :
    MATCH "int a_local;" -> GOTO ARG292;
    TRUE -> STOP;

STATE USEFIRST ARG292 :
    MATCH "[a == 4]" -> ASSUME {a == (4);} GOTO ARG293;
    TRUE -> STOP;

STATE USEFIRST ARG293 :
    MATCH "g(p1, p2);" -> GOTO ARG294;
    TRUE -> STOP;

STATE USEFIRST ARG294 :
    MATCH "" -> ASSUME {p1 == (28LL);(*(p1)) == (44LL);(*(*(p1))) == (4);p2 == (8LL);} GOTO ARG295;
    TRUE -> STOP;

STATE USEFIRST ARG295 :
    MATCH "int *piVar1;" -> ASSUME {p1 == (28LL);(*(p1)) == (44LL);(*(*(p1))) == (4);p2 == (8LL);} GOTO ARG296;
    TRUE -> STOP;

STATE USEFIRST ARG296 :
    MATCH "int **p2_local;" -> GOTO ARG297;
    TRUE -> STOP;

STATE USEFIRST ARG297 :
    MATCH "int **p1_local;" -> GOTO ARG298;
    TRUE -> STOP;

STATE USEFIRST ARG298 :
    MATCH "int *pq;" -> GOTO ARG299;
    TRUE -> STOP;

STATE USEFIRST ARG299 :
    MATCH "piVar1 = *p2;" -> ASSUME {piVar1 == (0LL);} GOTO ARG300;
    TRUE -> STOP;

STATE USEFIRST ARG300 :
    MATCH "*p1 = *p2;" -> ASSUME {(*(p1)) == (44LL);(*(*(p1))) == (4);} GOTO ARG301;
    TRUE -> STOP;

STATE USEFIRST ARG301 :
    MATCH "*piVar1 = 0;" -> ASSUME {(*(piVar1)) == (0);} GOTO ARG302;
    TRUE -> STOP;

STATE USEFIRST ARG302 :
    MATCH "return;" -> GOTO ARG303;
    TRUE -> STOP;
...
STATE USEFIRST ARG305 :
    MATCH "return (int)(a == 4);" -> GOTO ARG306;
    TRUE -> STOP;
...
STATE USEFIRST ARG307 :
    MATCH "[*p2 == 0]" -> ASSUME {(*(p2)) == (1);} GOTO ARG308;
    TRUE -> STOP;

STATE USEFIRST ARG308 :
    MATCH "iVar1 = 0x100000;" -> GOTO ARG312;
    TRUE -> STOP;
...
STATE USEFIRST ARG316 :
    MATCH "0 && \"Assertion failed: *p2 should not be 0\"" -> GOTO ARG317;
    TRUE -> STOP;

STATE USEFIRST ARG317 :
    MATCH "__assert_fail (\n# 50 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test06_process_dc_iter1.c\"\n       \"0 && \\\"Assertion failed: *p2 should not be 0\\\"\"\n# 50 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test06_process_dc_iter1.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test06_process_dc_iter1.c\", 50, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
