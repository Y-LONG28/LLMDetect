...
int main_0() {
  ...
  __assert_fail("0 && \"Assertion failed: y1*x2 + y2 == x1\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/mannadiv_unwindbound2_process_dc_iter1.c", 49, "__PRETTY_FUNCTION__");
}
