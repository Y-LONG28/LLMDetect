...
STATE USEFIRST ARG22_298_1 :
    MATCH "uint local_14;" -> GOTO ARG22_299_1;
STATE USEFIRST ARG22_299_1 :
    MATCH "uint x;" -> GOTO ARG22;
    TRUE -> STOP;
...
STATE USEFIRST ARG24 :
    MATCH "[!(local_14 < 0xfffffff)]" -> ASSUME {local_14 == (268435455U);} GOTO ARG26;
    TRUE -> STOP;

STATE USEFIRST ARG26 :
    MATCH "[local_14 < 0x10000000]" -> ASSUME {local_14 == (268435455U);} GOTO ARG27;
    TRUE -> STOP;
...
STATE USEFIRST ARG29_4_2 :
    MATCH "0 && \"Assertion failed: x > 0x0fffffff\"" -> GOTO ARG29;
    TRUE -> STOP;

STATE USEFIRST ARG29 :
    MATCH "__assert_fail (\n# 21 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/simple_2-2_process_dc_iter1.c\"\n       \"0 && \\\"Assertion failed: x > 0x0fffffff\\\"\"\n# 21 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/simple_2-2_process_dc_iter1.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/simple_2-2_process_dc_iter1.c\", 21, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
