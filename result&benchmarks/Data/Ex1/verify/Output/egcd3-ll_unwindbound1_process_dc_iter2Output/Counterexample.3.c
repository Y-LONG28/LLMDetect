...
int main_0() {
  ...
  __assert_fail("0 && \"Assertion failed: p*x - q*x + r*y - s*y == a\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd3-ll_unwindbound1_process_dc_iter2.c", 50, "__PRETTY_FUNCTION__");
}
