...
int main_0() {
  ...
  tmp_var_1_uint = 1;
  A = 0;
  __CPROVER_assume(counter < 50);
  __CPROVER_assume(!(q != (local_2c * tmp_var_1_uint)));
  __CPROVER_assume(!(tmp_var_2_uint < q));
  q = q << 1;
  tmp_var_1_uint = tmp_var_1_uint << 1;
  const int __CPAchecker_TMP_3 = counter;
  counter = counter + 1;
  __CPAchecker_TMP_3;
  __CPROVER_assume(counter < 50);
  __CPROVER_assume(!(q != (local_2c * tmp_var_1_uint)));
  ...
  __CPROVER_assume(!(q != (local_2c * tmp_var_1_uint)));
  __CPROVER_assume(tmp_var_2_uint < q);
  __CPROVER_assume(!(counter > 49));
  __CPROVER_assume(!(tmp_var_2_uint != ((A * local_2c) + p)));
  __CPROVER_assume(!(q != (local_2c * tmp_var_1_uint)));
  __CPROVER_assume(!(tmp_var_1_uint == 1));
  q = q >> 1;
  tmp_var_1_uint = tmp_var_1_uint >> 1;
  __CPROVER_assume(q <= p);
  p = p - q;
  A = tmp_var_1_uint + A;
  const int __CPAchecker_TMP_22 = counter;
  counter = counter + 1;
  __CPAchecker_TMP_22;
  __CPROVER_assume(!(counter > 49));
  __CPROVER_assume(!(tmp_var_2_uint != ((A * local_2c) + p)));
  ...
  __CPROVER_assume(!(counter > 49));
  __CPROVER_assume(tmp_var_2_uint != ((A * local_2c) + p));
  int __CPAchecker_TMP_12;
  __CPAchecker_TMP_12 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: A == q*B + r\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/hard-u_unwindbound50_process_dc_iter1.c", 53, "__PRETTY_FUNCTION__");
}
