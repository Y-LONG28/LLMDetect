...
STATE USEFIRST ARG296 :
    MATCH "typedef union {\n    double value;\n    struct {\n        uint32_t lsw;\n        uint32_t msw;\n    } parts;\n} ieee_double_shape_type;" -> GOTO ARG297;
    TRUE -> STOP;

STATE USEFIRST ARG297 :
    MATCH "typedef union {\n    double value;\n    struct {\n        uint32_t lsw;\n        uint32_t msw;\n    } parts;\n} ieee_double_shape_type;" -> GOTO ARG298;
    TRUE -> STOP;

STATE USEFIRST ARG298 :
    MATCH "typedef union {\n    double value;\n    struct {\n        uint32_t lsw;\n        uint32_t msw;\n    } parts;\n} ieee_double_shape_type;" -> GOTO ARG299;
    TRUE -> STOP;

STATE USEFIRST ARG299 :
    MATCH "int isnan_double(double x)" -> GOTO ARG300;
    TRUE -> STOP;

STATE USEFIRST ARG300 :
    MATCH "int __fpclassify_double(double x)" -> GOTO ARG301;
    TRUE -> STOP;

STATE USEFIRST ARG301 :
    MATCH "double fmin_double(double x, double y)" -> GOTO ARG302;
    TRUE -> STOP;

STATE USEFIRST ARG302 :
    MATCH "int __signbit_double(double x)" -> GOTO ARG303;
    TRUE -> STOP;

STATE USEFIRST ARG303 :
    MATCH "void assume(int cond)" -> GOTO ARG304;
    TRUE -> STOP;

STATE USEFIRST ARG304 :
    MATCH "int main(void)" -> GOTO ARG305;
    TRUE -> STOP;
...
STATE USEFIRST ARG306 :
    MATCH "int iVar1;" -> GOTO ARG307;
    TRUE -> STOP;

STATE USEFIRST ARG307 :
    MATCH "double in_a0;" -> GOTO ARG308;
    TRUE -> STOP;

STATE USEFIRST ARG308 :
    MATCH "double x_00;" -> GOTO ARG309;
    TRUE -> STOP;

STATE USEFIRST ARG309 :
    MATCH "double in_a1;" -> ASSUME {in_a1 == (4.9E-324);} GOTO ARG310;
    TRUE -> STOP;

STATE USEFIRST ARG310 :
    MATCH "double extraout_fa0;" -> ASSUME {extraout_fa0 == (2.0);} GOTO ARG311;
    TRUE -> STOP;

STATE USEFIRST ARG311 :
    MATCH "double res;" -> GOTO ARG312;
    TRUE -> STOP;

STATE USEFIRST ARG312 :
    MATCH "double y;" -> GOTO ARG313;
    TRUE -> STOP;

STATE USEFIRST ARG313 :
    MATCH "double x;" -> GOTO ARG314;
    TRUE -> STOP;

STATE USEFIRST ARG314 :
    MATCH "x_00 = fmin_double(in_a0, in_a1);" -> GOTO ARG315;
    TRUE -> STOP;

STATE USEFIRST ARG315 :
    MATCH "" -> ASSUME {y == (4.9E-324);} GOTO ARG316;
    TRUE -> STOP;

STATE USEFIRST ARG316 :
    MATCH "int iVar1;" -> ASSUME {y == (4.9E-324);} GOTO ARG317;
    TRUE -> STOP;

STATE USEFIRST ARG317 :
    MATCH "double dVar2;" -> GOTO ARG318;
    TRUE -> STOP;

STATE USEFIRST ARG318 :
    MATCH "double y_local;" -> GOTO ARG319;
    TRUE -> STOP;

STATE USEFIRST ARG319 :
    MATCH "double x_local;" -> GOTO ARG320;
    TRUE -> STOP;

STATE USEFIRST ARG320 :
    MATCH "iVar1 = __fpclassify_double(x);" -> GOTO ARG321;
    TRUE -> STOP;
...
STATE USEFIRST ARG322 :
    MATCH "int iVar1;" -> GOTO ARG323;
    TRUE -> STOP;

STATE USEFIRST ARG323 :
    MATCH "double x_local;" -> GOTO ARG324;
    TRUE -> STOP;

STATE USEFIRST ARG324 :
    MATCH "ieee_double_shape_type ew_u;" -> ASSUME {(&ew_u) == (4LL);} GOTO ARG325;
    TRUE -> STOP;

STATE USEFIRST ARG325 :
    MATCH "uint32_t lsw;" -> GOTO ARG326;
    TRUE -> STOP;

STATE USEFIRST ARG326 :
    MATCH "uint32_t msw;" -> GOTO ARG327;
    TRUE -> STOP;

STATE USEFIRST ARG327 :
    MATCH "ew_u.value = x;" -> GOTO ARG328;
    TRUE -> STOP;

STATE USEFIRST ARG328 :
    MATCH "lsw = ew_u.parts.lsw;" -> ASSUME {lsw == (1U);} GOTO ARG329;
    TRUE -> STOP;

STATE USEFIRST ARG329 :
    MATCH "msw = ew_u.parts.msw;" -> ASSUME {msw == (4293918720U);} GOTO ARG330;
    TRUE -> STOP;

STATE USEFIRST ARG330 :
    MATCH "[!(((msw == 0) && (lsw == 0)) || ((msw == 0x80000000 && (lsw == 0))))]" -> ASSUME {msw == (4293918720U);} GOTO ARG335;
    TRUE -> STOP;

STATE USEFIRST ARG335 :
    MATCH "[!(((msw == 0) && (lsw == 0)) || ((msw == 0x80000000 && (lsw == 0))))]" -> ASSUME {msw == (4293918720U);} GOTO ARG341;
    TRUE -> STOP;

STATE USEFIRST ARG341 :
    MATCH "[!(((msw < 0x100000) || (0x7fefffff < msw)) && ((msw < 0x80100000 || (0xffefffff < msw))))]" -> ASSUME {msw == (4293918720U);} GOTO ARG343;
    MATCH "[((msw < 0x100000) || (0x7fefffff < msw)) && ((msw < 0x80100000 || (0xffefffff < msw)))]" -> GOTO ARG346;
    TRUE -> STOP;

STATE USEFIRST ARG343 :
    MATCH "[((msw < 0x100000) || (0x7fefffff < msw)) && ((msw < 0x80100000 || (0xffefffff < msw)))]" -> ASSUME {msw == (4293918720U);} GOTO ARG346;
    TRUE -> STOP;

STATE USEFIRST ARG346 :
    MATCH "[!(((msw < 0x100000) || (0x7fefffff < msw)) && ((msw < 0x80100000 || (0xffefffff < msw))))]" -> ASSUME {msw == (4293918720U);} GOTO ARG348;
    MATCH "[((msw < 0x100000) || (0x7fefffff < msw)) && ((msw < 0x80100000 || (0xffefffff < msw)))]" -> GOTO ARG351;
    TRUE -> STOP;

STATE USEFIRST ARG348 :
    MATCH "[((msw < 0x100000) || (0x7fefffff < msw)) && ((msw < 0x80100000 || (0xffefffff < msw)))]" -> ASSUME {msw == (4293918720U);} GOTO ARG351;
    TRUE -> STOP;

STATE USEFIRST ARG351 :
    MATCH "[!((msw < 0x100000) || ((x < 0 && (msw < 0x80100000))))]" -> ASSUME {msw == (4293918720U);} GOTO ARG356;
    TRUE -> STOP;

STATE USEFIRST ARG356 :
    MATCH "[!((msw < 0x100000) || ((x < 0 && (msw < 0x80100000))))]" -> GOTO ARG362;
    TRUE -> STOP;

STATE USEFIRST ARG362 :
    MATCH "[!(((msw == 0x7ff00000) && (lsw == 0)) || ((msw == 0xfff00000 && (lsw == 0))))]" -> ASSUME {msw == (4293918720U);} GOTO ARG367;
    TRUE -> STOP;

STATE USEFIRST ARG367 :
    MATCH "[((msw == 0x7ff00000) && (lsw == 0)) || ((msw == 0xfff00000 && (lsw == 0)))]" -> ASSUME {msw == (4293918720U);} GOTO ARG368;
    MATCH "[!(((msw == 0x7ff00000) && (lsw == 0)) || ((msw == 0xfff00000 && (lsw == 0))))]" -> GOTO ARG373;
    TRUE -> STOP;

STATE USEFIRST ARG368 :
    MATCH "[!(((msw == 0x7ff00000) && (lsw == 0)) || ((msw == 0xfff00000 && (lsw == 0))))]" -> ASSUME {lsw == (1U);} GOTO ARG373;
    TRUE -> STOP;

STATE USEFIRST ARG373 :
    MATCH "iVar1 = 0;" -> ASSUME {iVar1 == (0);} GOTO ARG374;
    TRUE -> STOP;
...
STATE USEFIRST ARG386 :
    MATCH "return iVar1;" -> GOTO ARG387;
    TRUE -> STOP;
...
STATE USEFIRST ARG388 :
    MATCH "[iVar1 == 0]" -> ASSUME {iVar1 == (0);} GOTO ARG389;
    TRUE -> STOP;

STATE USEFIRST ARG389 :
    MATCH "dVar2 = 0.0;" -> ASSUME {dVar2 == (0.0);} GOTO ARG461;
    TRUE -> STOP;
...
STATE USEFIRST ARG463 :
    MATCH "return dVar2;" -> GOTO ARG464;
    TRUE -> STOP;
...
STATE USEFIRST ARG465 :
    MATCH "[(extraout_fa0 != 0.0) || (iVar1 = __signbit_double(x_00), iVar1 != 1)]" -> ASSUME {extraout_fa0 == (2.0);} GOTO ARG479;
    TRUE -> STOP;
...
STATE USEFIRST ARG483 :
    MATCH "0 && \"Assertion failed: extraout_fa0 should be 0.0 or signbit should be 1\"" -> GOTO ARG484;
    TRUE -> STOP;

STATE USEFIRST ARG484 :
    MATCH "__assert_fail (\n# 86 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/double_req_bl_1232b_process_dc_iter1.c\"\n       \"0 && \\\"Assertion failed: extraout_fa0 should be 0.0 or signbit should be 1\\\"\"\n# 86 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/double_req_bl_1232b_process_dc_iter1.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/double_req_bl_1232b_process_dc_iter1.c\", 86, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
