...
int main_0() {
  ...
  int tmp_var_1_int;
  local_18 = 0;
  __CPROVER_assume(local_18 < 20);
  ((&dStack_d8)[local_18]).a = (ad1[19]).b;
  (ad1[((long)local_18) + -1]).b = (ad1[19]).a;
  local_18 = local_18 + 1;
  __CPROVER_assume(local_18 < 20);
  ((&dStack_d8)[local_18]).a = (ad1[19]).b;
  (ad1[((long)local_18) + -1]).b = (ad1[19]).a;
  ...
  local_18 = local_18 + 1;
  __CPROVER_assume(!(local_18 < 20));
  __CPROVER_assume(-1 < (ad2->a));
  __CPROVER_assume((ad2->a) < 10);
  ((&dStack_d8)[ad2->a]).a = ad2->a;
  tmp_var_1_int = (((&dStack_d8)[ad2->a]).a) + 10;
  __CPROVER_assume(!(tmp_var_1_int < (((&dStack_d8)[ad2->a]).a)));
  iVar1 = check_1(&dStack_d8, tmp_var_1_int);
  __CPROVER_assume((extraout_var | iVar1) == 0);
  iVar1 = 1048576;
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: check function returned 0\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test24-2_process_dc_iter2.c", 53, "__PRETTY_FUNCTION__");
}
