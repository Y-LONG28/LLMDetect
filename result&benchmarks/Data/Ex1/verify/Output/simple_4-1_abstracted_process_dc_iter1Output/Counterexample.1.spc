...
STATE USEFIRST ARG299 :
    MATCH "uint x__VERIFIER_LA_old_tmp0;" -> GOTO ARG300;
    TRUE -> STOP;

STATE USEFIRST ARG300 :
    MATCH "long long __VERIFIER_LA_iterations0;" -> GOTO ARG301;
    TRUE -> STOP;

STATE USEFIRST ARG301 :
    MATCH "long long x__VERIFIER_LA_tmp0;" -> GOTO ARG302;
    TRUE -> STOP;

STATE USEFIRST ARG302 :
    MATCH "uint x;" -> ASSUME {x == (1U);} GOTO ARG303;
    TRUE -> STOP;

STATE USEFIRST ARG303 :
    MATCH "(void) sizeof ((\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/simple_4-1_abstracted_process_dc_iter1.c\"\n   !(x % 2) && \"Assertion failed: x should be even\"\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/simple_4-1_abstracted_process_dc_iter1.c\" 3 4\n   ) ? 1 : 0)" -> GOTO ARG304;
    TRUE -> STOP;
...
STATE USEFIRST ARG313 :
    MATCH "[!(!(x % 2) && \"Assertion failed: x should be even\")]" -> GOTO ARG318;
    TRUE -> STOP;

STATE USEFIRST ARG318 :
    MATCH "__assert_fail (\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/simple_4-1_abstracted_process_dc_iter1.c\"\n   \"!(x % 2) && \\\"Assertion failed: x should be even\\\"\"\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/simple_4-1_abstracted_process_dc_iter1.c\" 3 4\n   , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/simple_4-1_abstracted_process_dc_iter1.c\", 19, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
