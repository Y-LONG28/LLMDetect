...
int main_0() {
  ...
  __CPROVER_assume(!(q != tmp_var_1_int));
  __CPROVER_assume(!(B < q));
  q = q << 1;
  ...
  __CPROVER_assume(!(B != ((q * A) + p)));
  __CPROVER_assume(q != 1);
  int __CPAchecker_TMP_9;
  __CPAchecker_TMP_9 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: B == d\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/hard2_unwindbound2_process_dc_iter1.c", 50, "__PRETTY_FUNCTION__");
}
