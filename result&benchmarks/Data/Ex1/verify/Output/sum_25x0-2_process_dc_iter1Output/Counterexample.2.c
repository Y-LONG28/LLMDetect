...
int sum_3(int n, int m);
int sum_4(int n, int m);
int sum_5(int n, int m);
int sum_6(int n, int m);
int sum_7(int n, int m);
int sum_8(int n, int m);
int sum_9(int n, int m);
int sum_10(int n, int m);
int sum_11(int n, int m);
int sum_12(int n, int m);
int sum_13(int n, int m);
int sum_14(int n, int m);
int sum_15(int n, int m);
int sum_16(int n, int m);
int sum_17(int n, int m);
int sum_18(int n, int m);
int sum_19(int n, int m);
int sum_20(int n, int m);
int sum_21(int n, int m);
int sum_22(int n, int m);
int sum_23(int n, int m);
int sum_24(int n, int m);
int sum_25(int n, int m);
int sum_26(int n, int m);
int main_0() {
  int iVar1;
  int result;
  int b;
  int a;
  iVar1 = sum_1(25, 0);
  __CPROVER_assume(iVar1 == 25);
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: iVar1 should not equal 0x19\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/sum_25x0-2_process_dc_iter1.c", 34, "__PRETTY_FUNCTION__");
}
