...
STATE USEFIRST ARG272 :
    MATCH "int a;" -> ASSUME {a == (0);} GOTO ARG273;
    TRUE -> STOP;

STATE USEFIRST ARG273 :
    MATCH "int b;" -> ASSUME {b == (0);} GOTO ARG274;
    TRUE -> STOP;

STATE USEFIRST ARG274 :
    MATCH "void equal(int *a, int *b);" -> GOTO ARG275;
    TRUE -> STOP;

STATE USEFIRST ARG275 :
    MATCH "void assume(int cond)" -> GOTO ARG276;
    TRUE -> STOP;

STATE USEFIRST ARG276 :
    MATCH "int main(void)" -> GOTO ARG277;
    TRUE -> STOP;
...
STATE USEFIRST ARG278 :
    MATCH "equal(&a, &b);" -> GOTO ARG279;
    TRUE -> STOP;

STATE USEFIRST ARG279 :
    MATCH "" -> ASSUME {a == (8LL);b == (1073741836LL);} GOTO ARG280;
    TRUE -> STOP;

STATE USEFIRST ARG280 :
    MATCH "[a != b]" -> ASSUME {a == (8LL);b == (1073741836LL);} GOTO ARG281;
    TRUE -> STOP;

STATE USEFIRST ARG281 :
    MATCH "(void) sizeof ((\n# 17 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test12_process_dc_iter1.c\"\n       0 && \"Assertion failed: a should equal b\"\n# 17 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test12_process_dc_iter1.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG283;
    TRUE -> STOP;
...
STATE USEFIRST ARG286 :
    MATCH "0 && \"Assertion failed: a should equal b\"" -> GOTO ARG287;
    TRUE -> STOP;

STATE USEFIRST ARG287 :
    MATCH "__assert_fail (\n# 17 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test12_process_dc_iter1.c\"\n       \"0 && \\\"Assertion failed: a should equal b\\\"\"\n# 17 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test12_process_dc_iter1.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test12_process_dc_iter1.c\", 17, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
