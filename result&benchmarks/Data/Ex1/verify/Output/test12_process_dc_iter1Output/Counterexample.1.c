...
void equal_1(int *a, int *b) {
  ...
  __assert_fail("0 && \"Assertion failed: a should equal b\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test12_process_dc_iter1.c", 17, "__PRETTY_FUNCTION__");
}
