...
STATE USEFIRST ARG296 :
    MATCH "typedef unsigned char uchar;" -> GOTO ARG297;
    TRUE -> STOP;
...
STATE USEFIRST ARG300 :
    MATCH "int iVar1;" -> GOTO ARG301;
    TRUE -> STOP;

STATE USEFIRST ARG301 :
    MATCH "uchar result_8;" -> GOTO ARG302;
    TRUE -> STOP;

STATE USEFIRST ARG302 :
    MATCH "uchar port;" -> GOTO ARG303;
    TRUE -> STOP;

STATE USEFIRST ARG303 :
    MATCH "iVar1 = 0x100000;" -> GOTO ARG304;
    TRUE -> STOP;

STATE USEFIRST ARG304 :
    MATCH "(void) sizeof ((\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/integerpromotion-3_process_dc_iter1.c\"\n   0 && \"Assertion failed: main function assertion\"\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/integerpromotion-3_process_dc_iter1.c\" 3 4\n   ) ? 1 : 0)" -> GOTO ARG305;
    TRUE -> STOP;
...
STATE USEFIRST ARG308 :
    MATCH "0 && \"Assertion failed: main function assertion\"" -> GOTO ARG309;
    TRUE -> STOP;

STATE USEFIRST ARG309 :
    MATCH "__assert_fail (\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/integerpromotion-3_process_dc_iter1.c\"\n   \"0 && \\\"Assertion failed: main function assertion\\\"\"\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/integerpromotion-3_process_dc_iter1.c\" 3 4\n   , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/integerpromotion-3_process_dc_iter1.c\", 19, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
