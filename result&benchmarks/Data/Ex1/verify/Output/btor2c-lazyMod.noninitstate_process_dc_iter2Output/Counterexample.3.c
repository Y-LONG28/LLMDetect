...
int main_0() {
  ...
  __CPROVER_assume(!(((_Bool)((~(expr_tmp_var_60_uchar == expr_tmp_var_61_uchar)) & 1)) == 0));
  bVar2 = 1;
  assume_1(bVar2);
  __CPROVER_assume(!(expr_tmp_var_60_uchar == expr_tmp_var_61_uchar));
  __CPROVER_assume(!(((~(constr_16_arg_0 & 1)) & 1) != 0));
  __CPROVER_assume((constr_16_arg_0 & 1) != 0);
  ...
  __assert_fail("0 && \"Assertion failed: !(bad_17_arg_0)\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/btor2c-lazyMod.noninitstate_process_dc_iter2.c", 39, "__PRETTY_FUNCTION__");
}
