...
STATE USEFIRST ARG273 :
    MATCH "int main(void)" -> GOTO ARG274;
    TRUE -> STOP;
...
STATE USEFIRST ARG275 :
    MATCH "float z;" -> GOTO ARG276;
    TRUE -> STOP;

STATE USEFIRST ARG276 :
    MATCH "float y;" -> ASSUME {y == (2.524354896707238E-29);} GOTO ARG277;
    TRUE -> STOP;

STATE USEFIRST ARG277 :
    MATCH "float x;" -> GOTO ARG278;
    TRUE -> STOP;

STATE USEFIRST ARG278 :
    MATCH "float tmp_var_1_float;" -> GOTO ARG279;
    TRUE -> STOP;

STATE USEFIRST ARG279 :
    MATCH "int cond;" -> GOTO ARG280;
    TRUE -> STOP;

STATE USEFIRST ARG280 :
    MATCH "[!((y < 0.0f) || (1.0f < y))]" -> ASSUME {y == (2.524354896707238E-29);} GOTO ARG282;
    TRUE -> STOP;

STATE USEFIRST ARG282 :
    MATCH "[!((y < 0.0f) || (1.0f < y))]" -> ASSUME {y == (2.524354896707238E-29);} GOTO ARG284;
    TRUE -> STOP;

STATE USEFIRST ARG284 :
    MATCH "cond = 1;" -> ASSUME {cond == (1);} GOTO ARG286;
    TRUE -> STOP;
...
STATE USEFIRST ARG290 :
    MATCH "assume(cond);" -> GOTO ARG291;
    TRUE -> STOP;

STATE USEFIRST ARG291 :
    MATCH "" -> ASSUME {cond == (1);} GOTO ARG292;
    TRUE -> STOP;

STATE USEFIRST ARG292 :
    MATCH "[!(!cond)]" -> ASSUME {cond == (1);} GOTO ARG294;
    TRUE -> STOP;
...
STATE USEFIRST ARG296 :
    MATCH "[(y != 0.0f) && (y * y == 0.0f)]" -> ASSUME {y == (2.524354896707238E-29);} GOTO ARG297;
    TRUE -> STOP;

STATE USEFIRST ARG297 :
    MATCH "[(y != 0.0f) && (y * y == 0.0f)]" -> GOTO ARG299;
    TRUE -> STOP;
...
STATE USEFIRST ARG305 :
    MATCH "0 && \"y != 0.f\"" -> GOTO ARG306;
    TRUE -> STOP;

STATE USEFIRST ARG306 :
    MATCH "__assert_fail (\n# 28 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/inv_square-1_process_dc_iter1.c\"\n       \"0 && \\\"y != 0.f\\\"\"\n# 28 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/inv_square-1_process_dc_iter1.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/inv_square-1_process_dc_iter1.c\", 28, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
