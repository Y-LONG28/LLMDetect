...
int main_0() {
  ...
  int cond;
  __CPROVER_assume(!(y < 0.0));
  __CPROVER_assume(!(1.0 < y));
  cond = 1;
  assume_1(cond);
  __CPROVER_assume(y != 0.0);
  __CPROVER_assume((y * y) == 0.0);
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"y != 0.f\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/inv_square-1_process_dc_iter1.c", 28, "__PRETTY_FUNCTION__");
}
