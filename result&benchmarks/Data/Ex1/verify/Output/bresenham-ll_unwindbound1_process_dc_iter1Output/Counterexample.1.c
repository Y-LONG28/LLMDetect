...
int main_0() {
  ...
  __CPROVER_assume(X != ((((long)yx) * 2) + ((((y * yx) - (v * tmp_var_2_int)) * 2) - ((long)tmp_var_2_int))));
  int __CPAchecker_TMP_3;
  __CPAchecker_TMP_3 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"2*yx - 2*xy - X + (long long) 2*Y - v == 0\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/bresenham-ll_unwindbound1_process_dc_iter1.c", 40, "__PRETTY_FUNCTION__");
}
