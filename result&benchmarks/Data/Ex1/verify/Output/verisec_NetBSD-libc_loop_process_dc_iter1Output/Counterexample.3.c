...
int main_0();
int glob2_1(Char *pathbuf, Char *pathlim);
int main_0() {
  Char CStack_20;
  Char CStack_1c;
  Char pathbuf[2];
  ...
  tmp = &CStack_1c;
  glob2_1(&CStack_20, (Char *)pathbuf);
}
...
int glob2_1(Char *pathbuf, Char *pathlim) {
  ...
  Char *tmp;
  local_18 = pathbuf;
  __CPROVER_assume(local_18 <= pathlim);
  __CPROVER_assume(tmp < local_18);
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: p <= tmp\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/verisec_NetBSD-libc_loop_process_dc_iter1.c", 17, "__PRETTY_FUNCTION__");
}
