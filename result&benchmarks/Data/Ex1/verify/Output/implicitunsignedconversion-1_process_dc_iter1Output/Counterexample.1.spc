...
STATE USEFIRST ARG300 :
    MATCH "int minus_one;" -> GOTO ARG301;
    TRUE -> STOP;

STATE USEFIRST ARG301 :
    MATCH "uint plus_one;" -> GOTO ARG302;
    TRUE -> STOP;

STATE USEFIRST ARG302 :
    MATCH "iVar1 = 0x100000;" -> GOTO ARG303;
    TRUE -> STOP;
...
STATE USEFIRST ARG307 :
    MATCH "0 && \"Assertion failed: main function assertion\"" -> GOTO ARG308;
    TRUE -> STOP;

STATE USEFIRST ARG308 :
    MATCH "__assert_fail (\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/implicitunsignedconversion-1_process_dc_iter1.c\"\n   \"0 && \\\"Assertion failed: main function assertion\\\"\"\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/implicitunsignedconversion-1_process_dc_iter1.c\" 3 4\n   , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/implicitunsignedconversion-1_process_dc_iter1.c\", 19, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
