...
int main_0() {
  ...
  int a;
  iVar1 = sum_1(20, 0);
  __CPROVER_assume(iVar1 == 20);
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: iVar1 should not equal 0x14\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/sum_20x0-1_process_dc_iter1.c", 34, "__PRETTY_FUNCTION__");
}
