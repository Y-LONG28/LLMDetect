...
STATE USEFIRST ARG299 :
    MATCH "double cast(int i)" -> GOTO ARG300;
    TRUE -> STOP;

STATE USEFIRST ARG300 :
    MATCH "int main(void)" -> GOTO ARG301;
    TRUE -> STOP;
...
STATE USEFIRST ARG302 :
    MATCH "double r;" -> GOTO ARG303;
    TRUE -> STOP;

STATE USEFIRST ARG303 :
    MATCH "int a;" -> GOTO ARG304;
    TRUE -> STOP;

STATE USEFIRST ARG304 :
    MATCH "int tmp_var_1_int;" -> ASSUME {tmp_var_1_int == (-2147483648U);} GOTO ARG305;
    TRUE -> STOP;

STATE USEFIRST ARG305 :
    MATCH "r = cast(tmp_var_1_int);" -> GOTO ARG306;
    TRUE -> STOP;

STATE USEFIRST ARG306 :
    MATCH "" -> ASSUME {i == (-2147483648U);} GOTO ARG307;
    TRUE -> STOP;

STATE USEFIRST ARG307 :
    MATCH "u y;" -> ASSUME {(&y) == (4LL);i == (-2147483648U);} GOTO ARG308;
    TRUE -> STOP;

STATE USEFIRST ARG308 :
    MATCH "y.parts.low = i;" -> ASSUME {(y.parts.low) == (2147483648U);} GOTO ARG309;
    TRUE -> STOP;

STATE USEFIRST ARG309 :
    MATCH "y.parts.high = 0;" -> ASSUME {(y.parts.high) == (0U);} GOTO ARG310;
    TRUE -> STOP;

STATE USEFIRST ARG310 :
    MATCH "return y.d;" -> GOTO ARG311;
    TRUE -> STOP;
...
STATE USEFIRST ARG312 :
    MATCH "[r != (double)tmp_var_1_int]" -> ASSUME {r == (4.9E-324);} GOTO ARG313;
    TRUE -> STOP;

STATE USEFIRST ARG313 :
    MATCH "(void) sizeof ((\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cast_union_tight_process_dc_iter1.c\"\n       0 && \"Assertion failed: r == a\"\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cast_union_tight_process_dc_iter1.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG315;
    TRUE -> STOP;
...
STATE USEFIRST ARG318 :
    MATCH "0 && \"Assertion failed: r == a\"" -> GOTO ARG319;
    TRUE -> STOP;

STATE USEFIRST ARG319 :
    MATCH "__assert_fail (\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cast_union_tight_process_dc_iter1.c\"\n       \"0 && \\\"Assertion failed: r == a\\\"\"\n# 30 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cast_union_tight_process_dc_iter1.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cast_union_tight_process_dc_iter1.c\", 30, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
