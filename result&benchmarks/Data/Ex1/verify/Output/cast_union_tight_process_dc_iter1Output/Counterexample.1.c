...
int main_0() {
  ...
  int a;
  int tmp_var_1_int;
  r = cast_1(tmp_var_1_int);
  __CPROVER_assume(r != ((double)tmp_var_1_int));
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: r == a\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cast_union_tight_process_dc_iter1.c", 30, "__PRETTY_FUNCTION__");
}
