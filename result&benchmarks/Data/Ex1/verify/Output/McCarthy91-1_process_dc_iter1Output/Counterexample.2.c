...
int main_0() {
  ...
  int result;
  int x;
  iVar1 = f91_1(local_14);
  __CPROVER_assume(!(iVar1 == 91));
  __CPROVER_assume(!(102 < local_14));
  iVar1 = 1048576;
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: Condition not met\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/McCarthy91-1_process_dc_iter1.c", 37, "__PRETTY_FUNCTION__");
}

int f91_1(int x) {
  int iVar1;
  int x_local;
  __CPROVER_assume(!(x < 101));
  iVar1 = x - 10;
  return iVar1;
}
