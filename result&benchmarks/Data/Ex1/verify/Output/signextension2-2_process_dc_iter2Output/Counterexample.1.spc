...
STATE USEFIRST ARG300 :
    MATCH "ulong castToULong;" -> GOTO ARG301;
    TRUE -> STOP;

STATE USEFIRST ARG301 :
    MATCH "long castToLong2;" -> GOTO ARG302;
    TRUE -> STOP;

STATE USEFIRST ARG302 :
    MATCH "long castToLong;" -> GOTO ARG303;
    TRUE -> STOP;

STATE USEFIRST ARG303 :
    MATCH "int castToInt;" -> GOTO ARG304;
    TRUE -> STOP;

STATE USEFIRST ARG304 :
    MATCH "uint allOne;" -> GOTO ARG305;
    TRUE -> STOP;

STATE USEFIRST ARG305 :
    MATCH "iVar1 = 0x100000;" -> GOTO ARG306;
    TRUE -> STOP;

STATE USEFIRST ARG306 :
    MATCH "(void) sizeof ((\n# 23 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/signextension2-2_process_dc_iter2.c\"\n   0 && \"Assertion failed: main function assertion\"\n# 23 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/signextension2-2_process_dc_iter2.c\" 3 4\n   ) ? 1 : 0)" -> GOTO ARG307;
    TRUE -> STOP;
...
STATE USEFIRST ARG310 :
    MATCH "0 && \"Assertion failed: main function assertion\"" -> GOTO ARG311;
    TRUE -> STOP;

STATE USEFIRST ARG311 :
    MATCH "__assert_fail (\n# 23 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/signextension2-2_process_dc_iter2.c\"\n   \"0 && \\\"Assertion failed: main function assertion\\\"\"\n# 23 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/signextension2-2_process_dc_iter2.c\" 3 4\n   , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/signextension2-2_process_dc_iter2.c\", 23, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
