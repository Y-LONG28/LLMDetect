...
STATE USEFIRST ARG282 :
    MATCH "int count;" -> ASSUME {count == (0);} GOTO ARG283;
    TRUE -> STOP;

STATE USEFIRST ARG283 :
    MATCH "jmp_buf my_jump_buffer;" -> ASSUME {(&my_jump_buffer) == (4LL);(&(my_jump_buffer[0])) == (4LL);(&((my_jump_buffer[0]).__jmpbuf)) == (4LL);(&((my_jump_buffer[0]).__saved_mask)) == (40LL);(&((my_jump_buffer[0]).__saved_mask.__val)) == (40LL);} GOTO ARG284;
    TRUE -> STOP;
...
STATE USEFIRST ARG285 :
    MATCH "void foo(void)" -> GOTO ARG286;
    TRUE -> STOP;

STATE USEFIRST ARG286 :
    MATCH "int main(void)" -> GOTO ARG287;
    TRUE -> STOP;
...
STATE USEFIRST ARG288 :
    MATCH "_setjmp (\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_12-counting-global_unknown_1_neg_process_dc_iter1.c\"\n   my_jump_buffer\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_12-counting-global_unknown_1_neg_process_dc_iter1.c\" 3 4\n   )\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_12-counting-global_unknown_1_neg_process_dc_iter1.c\"\n                         ;" -> GOTO ARG289;
    TRUE -> STOP;

STATE USEFIRST ARG289 :
    MATCH "[count == 0]" -> ASSUME {count == (0);} GOTO ARG290;
    TRUE -> STOP;
...
STATE USEFIRST ARG294 :
    MATCH "0 && \"Assertion failed: count should not be 0\"" -> GOTO ARG295;
    TRUE -> STOP;

STATE USEFIRST ARG295 :
    MATCH "__assert_fail (\n# 21 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_12-counting-global_unknown_1_neg_process_dc_iter1.c\"\n       \"0 && \\\"Assertion failed: count should not be 0\\\"\"\n# 21 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_12-counting-global_unknown_1_neg_process_dc_iter1.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_12-counting-global_unknown_1_neg_process_dc_iter1.c\", 21, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
