...
int main_0() {
  ...
  int x;
  iVar1 = fibo1_1(5);
  __CPROVER_assume(iVar1 == 5);
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: iVar1 should not equal 5\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/fibo_2calls_5-2_process_dc_iter1.c", 57, "__PRETTY_FUNCTION__");
}
