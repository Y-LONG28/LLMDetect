...
STATE USEFIRST ARG272 :
    MATCH "int q;" -> GOTO ARG273;
    TRUE -> STOP;

STATE USEFIRST ARG273 :
    MATCH "void assume(int cond)" -> GOTO ARG274;
    TRUE -> STOP;

STATE USEFIRST ARG274 :
    MATCH "int main(void)" -> GOTO ARG275;
    TRUE -> STOP;
...
STATE USEFIRST ARG276 :
    MATCH "int iVar1;" -> GOTO ARG277;
    TRUE -> STOP;

STATE USEFIRST ARG277 :
    MATCH "int iStack_24;" -> GOTO ARG278;
    TRUE -> STOP;

STATE USEFIRST ARG278 :
    MATCH "int *piStack_20;" -> GOTO ARG279;
    TRUE -> STOP;

STATE USEFIRST ARG279 :
    MATCH "int a;" -> GOTO ARG280;
    TRUE -> STOP;

STATE USEFIRST ARG280 :
    MATCH "int *p2;" -> GOTO ARG281;
    TRUE -> STOP;

STATE USEFIRST ARG281 :
    MATCH "int *p1;" -> GOTO ARG282;
    TRUE -> STOP;

STATE USEFIRST ARG282 :
    MATCH "piStack_20 = &iStack_24;" -> GOTO ARG283;
    TRUE -> STOP;

STATE USEFIRST ARG283 :
    MATCH "q = 0;" -> GOTO ARG284;
    TRUE -> STOP;

STATE USEFIRST ARG284 :
    MATCH "iVar1 = 0x100000;" -> GOTO ARG285;
    TRUE -> STOP;

STATE USEFIRST ARG285 :
    MATCH "p2 = piStack_20;" -> GOTO ARG286;
    TRUE -> STOP;
...
STATE USEFIRST ARG290 :
    MATCH "0 && \"Assertion failed: main\"" -> GOTO ARG291;
    TRUE -> STOP;

STATE USEFIRST ARG291 :
    MATCH "__assert_fail (\n# 25 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test02_process_dc_iter1.c\"\n   \"0 && \\\"Assertion failed: main\\\"\"\n# 25 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test02_process_dc_iter1.c\" 3 4\n   , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test02_process_dc_iter1.c\", 25, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
