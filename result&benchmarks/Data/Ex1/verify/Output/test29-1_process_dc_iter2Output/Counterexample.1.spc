...
STATE USEFIRST ARG278 :
    MATCH "dummy adStack_30[2];" -> ASSUME {(&adStack_30) == (4LL);(&(adStack_30[0])) == (4LL);(&(adStack_30[1])) == (12LL);} GOTO ARG279;
    TRUE -> STOP;

STATE USEFIRST ARG279 :
    MATCH "dummy d2;" -> ASSUME {(&d2) == (28LL);(d2.a) == (2);} GOTO ARG280;
    TRUE -> STOP;

STATE USEFIRST ARG280 :
    MATCH "dummy local_24;" -> ASSUME {(&local_24) == (48LL);(local_24.a) == (2);(local_24.b) == (0);} GOTO ARG281;
    TRUE -> STOP;

STATE USEFIRST ARG281 :
    MATCH "dummy d1;" -> ASSUME {(&d1) == (60LL);(d1.a) == (0);} GOTO ARG282;
    TRUE -> STOP;

STATE USEFIRST ARG282 :
    MATCH "int expr_tmp_var_21_int;" -> GOTO ARG283;
    TRUE -> STOP;

STATE USEFIRST ARG283 :
    MATCH "dummy *pd;" -> GOTO ARG284;
    TRUE -> STOP;

STATE USEFIRST ARG284 :
    MATCH "int n;" -> GOTO ARG285;
    TRUE -> STOP;

STATE USEFIRST ARG285 :
    MATCH "pd = &d1;" -> ASSUME {pd == (60LL);} GOTO ARG286;
    TRUE -> STOP;

STATE USEFIRST ARG286 :
    MATCH "[pd->a == 0]" -> GOTO ARG287;
    TRUE -> STOP;

STATE USEFIRST ARG287 :
    MATCH "pd = adStack_30;" -> ASSUME {pd == (4LL);} GOTO ARG291;
    TRUE -> STOP;
...
STATE USEFIRST ARG293 :
    MATCH "d2 = local_24;" -> ASSUME {(&d2) == (28LL);(d2.a) == (2);(d2.a) == (2);(d2.b) == (0);} GOTO ARG294;
    TRUE -> STOP;

STATE USEFIRST ARG294 :
    MATCH "[!(pd == &d2)]" -> ASSUME {pd == (4LL);} GOTO ARG296;
    TRUE -> STOP;

STATE USEFIRST ARG296 :
    MATCH "pd->b = '\\0';" -> GOTO ARG297;
    TRUE -> STOP;
...
STATE USEFIRST ARG301 :
    MATCH "[(pd == adStack_30) && (d2.a != 0)]" -> ASSUME {pd == (4LL);(&adStack_30) == (4LL);(&(adStack_30[0])) == (4LL);(&(adStack_30[1])) == (12LL);} GOTO ARG302;
    TRUE -> STOP;

STATE USEFIRST ARG302 :
    MATCH "[(pd == adStack_30) && (d2.a != 0)]" -> ASSUME {(d2.a) == (2);} GOTO ARG304;
    TRUE -> STOP;

STATE USEFIRST ARG304 :
    MATCH "iVar1 = 0x100000;" -> GOTO ARG309;
    TRUE -> STOP;

STATE USEFIRST ARG309 :
    MATCH "(void) sizeof ((\n# 42 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test29-1_process_dc_iter2.c\"\n       0 && \"Assertion failed: pd == adStack_30 && d2.a != 0\"\n# 42 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test29-1_process_dc_iter2.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG310;
    TRUE -> STOP;
...
STATE USEFIRST ARG313 :
    MATCH "0 && \"Assertion failed: pd == adStack_30 && d2.a != 0\"" -> GOTO ARG314;
    TRUE -> STOP;

STATE USEFIRST ARG314 :
    MATCH "__assert_fail (\n# 42 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test29-1_process_dc_iter2.c\"\n       \"0 && \\\"Assertion failed: pd == adStack_30 && d2.a != 0\\\"\"\n# 42 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test29-1_process_dc_iter2.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test29-1_process_dc_iter2.c\", 42, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
