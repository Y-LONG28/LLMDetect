...
STATE USEFIRST ARG299 :
    MATCH "int iVar1;" -> GOTO ARG300;
    TRUE -> STOP;

STATE USEFIRST ARG300 :
    MATCH "uint signedtounsigned;" -> GOTO ARG301;
    TRUE -> STOP;

STATE USEFIRST ARG301 :
    MATCH "int signedtosigned;" -> GOTO ARG302;
    TRUE -> STOP;

STATE USEFIRST ARG302 :
    MATCH "uint unsignedtounsigned;" -> GOTO ARG303;
    TRUE -> STOP;

STATE USEFIRST ARG303 :
    MATCH "int unsignedtosigned;" -> GOTO ARG304;
    TRUE -> STOP;

STATE USEFIRST ARG304 :
    MATCH "short signedallbits;" -> GOTO ARG305;
    TRUE -> STOP;

STATE USEFIRST ARG305 :
    MATCH "ushort allbits;" -> GOTO ARG306;
    TRUE -> STOP;

STATE USEFIRST ARG306 :
    MATCH "iVar1 = 0x100000;" -> GOTO ARG307;
    TRUE -> STOP;

STATE USEFIRST ARG307 :
    MATCH "(void) sizeof ((\n# 24 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/signextension-1_process_dc_iter1.c\"\n   0 && \"Assertion failed: main function assertion\"\n# 24 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/signextension-1_process_dc_iter1.c\" 3 4\n   ) ? 1 : 0)" -> GOTO ARG308;
    TRUE -> STOP;
...
STATE USEFIRST ARG311 :
    MATCH "0 && \"Assertion failed: main function assertion\"" -> GOTO ARG312;
    TRUE -> STOP;

STATE USEFIRST ARG312 :
    MATCH "__assert_fail (\n# 24 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/signextension-1_process_dc_iter1.c\"\n   \"0 && \\\"Assertion failed: main function assertion\\\"\"\n# 24 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/signextension-1_process_dc_iter1.c\" 3 4\n   , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/signextension-1_process_dc_iter1.c\", 24, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
