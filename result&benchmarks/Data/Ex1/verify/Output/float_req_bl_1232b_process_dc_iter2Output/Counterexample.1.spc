...
STATE USEFIRST ARG298 :
    MATCH "typedef uint32_t undefined4;" -> GOTO ARG299;
    TRUE -> STOP;

STATE USEFIRST ARG299 :
    MATCH "int __fpclassify_float(float x);" -> GOTO ARG300;
    TRUE -> STOP;

STATE USEFIRST ARG300 :
    MATCH "float fmin_float(float x, float y);" -> GOTO ARG301;
    TRUE -> STOP;

STATE USEFIRST ARG301 :
    MATCH "int __signbit_float(float x);" -> GOTO ARG302;
    TRUE -> STOP;

STATE USEFIRST ARG302 :
    MATCH "void assume(int cond);" -> GOTO ARG303;
    TRUE -> STOP;

STATE USEFIRST ARG303 :
    MATCH "int main(void)" -> GOTO ARG304;
    TRUE -> STOP;
...
STATE USEFIRST ARG305 :
    MATCH "float in_a0;" -> ASSUME {in_a0 == (0.0);} GOTO ARG306;
    TRUE -> STOP;

STATE USEFIRST ARG306 :
    MATCH "float x_00;" -> GOTO ARG307;
    TRUE -> STOP;

STATE USEFIRST ARG307 :
    MATCH "int iVar1;" -> GOTO ARG308;
    TRUE -> STOP;

STATE USEFIRST ARG308 :
    MATCH "undefined4 extraout_var;" -> GOTO ARG309;
    TRUE -> STOP;

STATE USEFIRST ARG309 :
    MATCH "float in_a1;" -> GOTO ARG310;
    TRUE -> STOP;

STATE USEFIRST ARG310 :
    MATCH "float extraout_fa0;" -> ASSUME {extraout_fa0 == (2.0);} GOTO ARG311;
    TRUE -> STOP;

STATE USEFIRST ARG311 :
    MATCH "x_00 = fmin_float(in_a0, in_a1);" -> GOTO ARG312;
    TRUE -> STOP;

STATE USEFIRST ARG312 :
    MATCH "" -> ASSUME {x == (0.0);} GOTO ARG313;
    TRUE -> STOP;

STATE USEFIRST ARG313 :
    MATCH "float x_00;" -> ASSUME {x == (0.0);} GOTO ARG314;
    TRUE -> STOP;

STATE USEFIRST ARG314 :
    MATCH "undefined4 extraout_var;" -> ASSUME {extraout_var == (0U);} GOTO ARG315;
    TRUE -> STOP;

STATE USEFIRST ARG315 :
    MATCH "float y_local;" -> GOTO ARG316;
    TRUE -> STOP;

STATE USEFIRST ARG316 :
    MATCH "float x_local;" -> GOTO ARG317;
    TRUE -> STOP;
...
STATE USEFIRST ARG318 :
    MATCH "x_00 = (float)__fpclassify_float(x);" -> GOTO ARG319;
    TRUE -> STOP;

STATE USEFIRST ARG319 :
    MATCH "" -> ASSUME {x == (0.0);} GOTO ARG320;
    TRUE -> STOP;

STATE USEFIRST ARG320 :
    MATCH "int iVar1;" -> ASSUME {x == (0.0);} GOTO ARG321;
    TRUE -> STOP;

STATE USEFIRST ARG321 :
    MATCH "uint in_fa0;" -> GOTO ARG322;
    TRUE -> STOP;

STATE USEFIRST ARG322 :
    MATCH "ieee_float_shape_type gf_u;" -> ASSUME {(&gf_u) == (4LL);} GOTO ARG323;
    TRUE -> STOP;

STATE USEFIRST ARG323 :
    MATCH "gf_u.value = x;" -> ASSUME {(gf_u.value) == (0.0);} GOTO ARG324;
    TRUE -> STOP;

STATE USEFIRST ARG324 :
    MATCH "in_fa0 = gf_u.word;" -> ASSUME {in_fa0 == (0U);} GOTO ARG325;
    TRUE -> STOP;

STATE USEFIRST ARG325 :
    MATCH "[(in_fa0 == 0) || (in_fa0 == 0x80000000)]" -> ASSUME {in_fa0 == (0U);} GOTO ARG330;
    TRUE -> STOP;

STATE USEFIRST ARG330 :
    MATCH "iVar1 = 2;" -> ASSUME {iVar1 == (2);} GOTO ARG371;
    TRUE -> STOP;
...
STATE USEFIRST ARG373 :
    MATCH "return iVar1;" -> GOTO ARG374;
    TRUE -> STOP;
...
STATE USEFIRST ARG375 :
    MATCH "x_00 = (float)__fpclassify_float(x);" -> ASSUME {x_00 == (2.0);} GOTO ARG376;
    TRUE -> STOP;

STATE USEFIRST ARG376 :
    MATCH "[!((extraout_var != 0) || (x_00 != 0))]" -> ASSUME {extraout_var == (0U);} GOTO ARG378;
    MATCH "[(extraout_var != 0) || (x_00 != 0)]" -> GOTO ARG381;
    TRUE -> STOP;

STATE USEFIRST ARG378 :
    MATCH "[(extraout_var != 0) || (x_00 != 0)]" -> ASSUME {x_00 == (2.0);} GOTO ARG381;
    MATCH "[!((extraout_var != 0) || (x_00 != 0))]" -> GOTO ARG442;
    TRUE -> STOP;
...
STATE USEFIRST ARG382 :
    MATCH "x_00 = (float)__fpclassify_float(x_00);" -> GOTO ARG383;
    TRUE -> STOP;

STATE USEFIRST ARG383 :
    MATCH "" -> ASSUME {x == (2.0);} GOTO ARG384;
    TRUE -> STOP;

STATE USEFIRST ARG384 :
    MATCH "int iVar1;" -> ASSUME {iVar1 == (2);x == (2.0);} GOTO ARG385;
    TRUE -> STOP;

STATE USEFIRST ARG385 :
    MATCH "uint in_fa0;" -> ASSUME {in_fa0 == (0U);} GOTO ARG386;
    TRUE -> STOP;

STATE USEFIRST ARG386 :
    MATCH "ieee_float_shape_type gf_u;" -> ASSUME {(&gf_u) == (4LL);(gf_u.value) == (0.0);(gf_u.word) == (0LL);} GOTO ARG387;
    TRUE -> STOP;

STATE USEFIRST ARG387 :
    MATCH "gf_u.value = x;" -> ASSUME {(gf_u.value) == (2.0);} GOTO ARG388;
    TRUE -> STOP;

STATE USEFIRST ARG388 :
    MATCH "in_fa0 = gf_u.word;" -> ASSUME {in_fa0 == (1073741824U);} GOTO ARG389;
    TRUE -> STOP;

STATE USEFIRST ARG389 :
    MATCH "[!((in_fa0 == 0) || (in_fa0 == 0x80000000))]" -> ASSUME {in_fa0 == (1073741824U);} GOTO ARG391;
    TRUE -> STOP;

STATE USEFIRST ARG391 :
    MATCH "[!((in_fa0 == 0) || (in_fa0 == 0x80000000))]" -> ASSUME {in_fa0 == (1073741824U);} GOTO ARG393;
    TRUE -> STOP;

STATE USEFIRST ARG393 :
    MATCH "[!(((in_fa0 < 0x800000) || (0x7f7fffff < in_fa0)) &&\n               ((in_fa0 < 0x80800000 || (0xff7fffff < in_fa0))))]" -> ASSUME {in_fa0 == (1073741824U);} GOTO ARG396;
    TRUE -> STOP;

STATE USEFIRST ARG396 :
    MATCH "[!(((in_fa0 < 0x800000) || (0x7f7fffff < in_fa0)) &&\n               ((in_fa0 < 0x80800000 || (0xff7fffff < in_fa0))))]" -> ASSUME {in_fa0 == (1073741824U);} GOTO ARG405;
    TRUE -> STOP;

STATE USEFIRST ARG405 :
    MATCH "iVar1 = 4;" -> ASSUME {iVar1 == (4);} GOTO ARG406;
    TRUE -> STOP;
...
STATE USEFIRST ARG437 :
    MATCH "return iVar1;" -> GOTO ARG438;
    TRUE -> STOP;
...
STATE USEFIRST ARG439 :
    MATCH "x_00 = (float)__fpclassify_float(x_00);" -> ASSUME {x_00 == (4.0);} GOTO ARG440;
    TRUE -> STOP;
...
STATE USEFIRST ARG444 :
    MATCH "[(extraout_fa0 != 0.0) || (iVar1 = __signbit_float(x_00), (extraout_var != 1))]" -> ASSUME {extraout_fa0 == (2.0);} GOTO ARG459;
    TRUE -> STOP;

STATE USEFIRST ARG459 :
    MATCH "(void) sizeof ((\n# 94 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_req_bl_1232b_process_dc_iter2.c\"\n       0 && \"Assertion failed: extraout_fa0 should be 0.0 or signbit should be 1\"\n# 94 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_req_bl_1232b_process_dc_iter2.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG460;
    TRUE -> STOP;
...
STATE USEFIRST ARG463 :
    MATCH "0 && \"Assertion failed: extraout_fa0 should be 0.0 or signbit should be 1\"" -> GOTO ARG464;
    TRUE -> STOP;

STATE USEFIRST ARG464 :
    MATCH "__assert_fail (\n# 94 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_req_bl_1232b_process_dc_iter2.c\"\n       \"0 && \\\"Assertion failed: extraout_fa0 should be 0.0 or signbit should be 1\\\"\"\n# 94 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_req_bl_1232b_process_dc_iter2.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_req_bl_1232b_process_dc_iter2.c\", 94, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
