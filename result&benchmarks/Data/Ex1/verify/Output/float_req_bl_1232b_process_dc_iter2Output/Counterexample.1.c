...
int main_0();
float fmin_float_1(float x, float y);
...
int main_0() {
  ...
  float in_a1;
  float extraout_fa0;
  x_00 = fmin_float_1(in_a0, in_a1);
  __CPROVER_assume(extraout_fa0 != 0.0);
  int __CPAchecker_TMP_3;
  __CPAchecker_TMP_3 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: extraout_fa0 should be 0.0 or signbit should be 1\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_req_bl_1232b_process_dc_iter2.c", 94, "__PRETTY_FUNCTION__");
}
