...
union __anon_type___atomic_wide_counter {
  ...
  struct __anon_type_1 __value32;
} ;
...
int main_0() {
  ...
  jmp_buf env_buffer2;
  int val;
  iVar1 = _setjmp(env_buffer);
  __CPROVER_assume(global == 0);
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: global should not be 0\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/68-longjmp_18-simple-else_unknown_1_neg_process_dc_iter1.c", 33, "__PRETTY_FUNCTION__");
}
