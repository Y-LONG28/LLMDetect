...
int main_0();
int ackermann_1(int m, int n);
int ackermann_2(int m, int n);
int ackermann_3(int m, int n);
int ackermann_4(int m, int n);
int ackermann_5(int m, int n);
int main_0() {
  int iVar1;
  int local_18;
  int result;
  ...
  __CPROVER_assume(!(3 < result));
  __CPROVER_assume(!(local_18 < 0));
  __CPROVER_assume(!(23 < local_18));
  iVar1 = ackermann_1(result, local_18);
  __CPROVER_assume(!(result < 2));
  __CPROVER_assume(!(3 < iVar1));
  iVar1 = 1048576;
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: result should not be in the range [2, 3] and iVar1 should not be greater than 3\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/Ackermann02_process_dc_iter1.c", 50, "__PRETTY_FUNCTION__");
}
...
int ackermann_2(int m, int n) {
  ...
  __CPROVER_assume(!(m == 0));
  __CPROVER_assume(!(n == 0));
  iVar1 = ackermann_3(m, n - 1);
  iVar1 = ackermann_5(m - 1, iVar1);
  return iVar1;
}
