...
int main_0() {
  ...
  __CPROVER_assume(!(x != ((((c * -30) + (((((x * x) * x) * x) * x) * 6)) + ((((x * x) * x) * x) * 15)) + (((x * x) * x) * 10))));
  ...
  __assert_fail("0 && \"k*y == y*y\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/ps5-ll_unwindbound1_process_dc_iter1.c", 48, "__PRETTY_FUNCTION__");
}
