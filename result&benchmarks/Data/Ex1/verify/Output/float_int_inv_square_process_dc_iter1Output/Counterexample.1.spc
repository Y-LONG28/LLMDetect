...
STATE USEFIRST ARG275 :
    MATCH "int cond;" -> GOTO ARG276;
    TRUE -> STOP;

STATE USEFIRST ARG276 :
    MATCH "float z;" -> GOTO ARG277;
    TRUE -> STOP;

STATE USEFIRST ARG277 :
    MATCH "float y;" -> ASSUME {y == (0.0);} GOTO ARG278;
    TRUE -> STOP;

STATE USEFIRST ARG278 :
    MATCH "int x;" -> GOTO ARG279;
    TRUE -> STOP;

STATE USEFIRST ARG279 :
    MATCH "int tmp_var_1_int;" -> GOTO ARG280;
    TRUE -> STOP;

STATE USEFIRST ARG280 :
    MATCH "[!(((int)y < -10) || (10 < (int)y))]" -> GOTO ARG282;
    TRUE -> STOP;

STATE USEFIRST ARG282 :
    MATCH "[!(((int)y < -10) || (10 < (int)y))]" -> GOTO ARG284;
    TRUE -> STOP;
...
STATE USEFIRST ARG296 :
    MATCH "[(float)((int)y * (int)y) - 0.0f == 0.0f]" -> GOTO ARG297;
    TRUE -> STOP;
...
STATE USEFIRST ARG302 :
    MATCH "0 && \"y != 0.f\"" -> GOTO ARG303;
    TRUE -> STOP;

STATE USEFIRST ARG303 :
    MATCH "__assert_fail (\n# 23 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_int_inv_square_process_dc_iter1.c\"\n       \"0 && \\\"y != 0.f\\\"\"\n# 23 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_int_inv_square_process_dc_iter1.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_int_inv_square_process_dc_iter1.c\", 23, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
