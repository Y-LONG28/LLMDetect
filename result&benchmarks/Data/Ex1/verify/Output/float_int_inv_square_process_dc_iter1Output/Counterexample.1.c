...
int main_0() {
  ...
  int x;
  int tmp_var_1_int;
  __CPROVER_assume(!(((int)y) < -10));
  __CPROVER_assume(!(10 < ((int)y)));
  cond = 1;
  assume_1(cond);
  __CPROVER_assume((((float)(((int)y) * ((int)y))) - 0.0) == 0.0);
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"y != 0.f\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_int_inv_square_process_dc_iter1.c", 23, "__PRETTY_FUNCTION__");
}
