...
int main_0() {
  ...
  __CPROVER_assume(!(lStack_30 != ((x + 1) * 6)));
  __CPROVER_assume(!(z != ((((x * x) + x) * 3) + 1)));
  __CPROVER_assume(!(y != ((x * x) * x)));
  __CPROVER_assume(!(((((z * lStack_30) + (y * -18)) + (z * -12)) + (lStack_30 * 2)) != 6));
  __CPROVER_assume(!((((lStack_30 * lStack_30) + (z * -12)) + (lStack_30 * -6)) != -12));
  __CPROVER_assume(!(local_32 < x));
  x = x + 1;
  y = z + y;
  z = lStack_30 + z;
  ...
  __CPROVER_assume(__CPAchecker_TMP_0 == 0);
  __CPROVER_assume(!(lStack_30 != ((x + 1) * 6)));
  __CPROVER_assume(((y * 12) + (((local_32 * 6) * y) - (y * lStack_30))) != 0);
  int __CPAchecker_TMP_21;
  __CPAchecker_TMP_21 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"6*a*x - x*z + 12*x == 0\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/cohencu-ll_unwindbound2_process_dc_iter1.c", 57, "__PRETTY_FUNCTION__");
}
