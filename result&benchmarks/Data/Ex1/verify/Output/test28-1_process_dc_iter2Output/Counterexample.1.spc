...
STATE USEFIRST ARG278 :
    MATCH "dummy *pdVar2;" -> GOTO ARG279;
    TRUE -> STOP;

STATE USEFIRST ARG279 :
    MATCH "dummy dStack_38;" -> ASSUME {(&dStack_38) == (4LL);(dStack_38.b) == (1);} GOTO ARG280;
    TRUE -> STOP;

STATE USEFIRST ARG280 :
    MATCH "dummy d2;" -> ASSUME {(&d2) == (28LL);} GOTO ARG281;
    TRUE -> STOP;

STATE USEFIRST ARG281 :
    MATCH "dummy d1;" -> ASSUME {(&d1) == (44LL);(d1.b) == (2);} GOTO ARG282;
    TRUE -> STOP;

STATE USEFIRST ARG282 :
    MATCH "dummy *pd = \n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test28-1_process_dc_iter2.c\" 3 4\n               ((void *)0)\n# 19 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test28-1_process_dc_iter2.c\"\n                   ;" -> ASSUME {pd == (0LL);} GOTO ARG283;
    TRUE -> STOP;

STATE USEFIRST ARG283 :
    MATCH "[pd == \n# 21 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test28-1_process_dc_iter2.c\" 3 4\n             ((void *)0)]" -> ASSUME {pd == (0LL);} GOTO ARG284;
    TRUE -> STOP;

STATE USEFIRST ARG284 :
    MATCH "pdVar2 = &dStack_38;" -> ASSUME {pdVar2 == (4LL);} GOTO ARG285;
    TRUE -> STOP;
...
STATE USEFIRST ARG286 :
    MATCH "[pdVar2 == &dStack_38]" -> ASSUME {pdVar2 == (4LL);} GOTO ARG287;
    TRUE -> STOP;

STATE USEFIRST ARG287 :
    MATCH "pdVar2->a = 0;" -> GOTO ARG291;
    TRUE -> STOP;

STATE USEFIRST ARG291 :
    MATCH "pdVar2->b = d1.b;" -> ASSUME {(pdVar2->b) == (2);} GOTO ARG292;
    TRUE -> STOP;
...
STATE USEFIRST ARG294 :
    MATCH "[(pdVar2 == &dStack_38) && (dStack_38.b != 0)]" -> ASSUME {pdVar2 == (4LL);(pdVar2->b) == (2);} GOTO ARG295;
    TRUE -> STOP;

STATE USEFIRST ARG295 :
    MATCH "[(pdVar2 == &dStack_38) && (dStack_38.b != 0)]" -> ASSUME {(dStack_38.b) == (2);} GOTO ARG297;
    TRUE -> STOP;

STATE USEFIRST ARG297 :
    MATCH "iVar1 = 0x100000;" -> GOTO ARG302;
    TRUE -> STOP;
...
STATE USEFIRST ARG306 :
    MATCH "0 && \"Assertion failed: dStack_38.b should be 0\"" -> GOTO ARG307;
    TRUE -> STOP;

STATE USEFIRST ARG307 :
    MATCH "__assert_fail (\n# 36 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test28-1_process_dc_iter2.c\"\n       \"0 && \\\"Assertion failed: dStack_38.b should be 0\\\"\"\n# 36 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test28-1_process_dc_iter2.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test28-1_process_dc_iter2.c\", 36, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
