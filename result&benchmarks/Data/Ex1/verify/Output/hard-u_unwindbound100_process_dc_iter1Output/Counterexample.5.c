...
int main_0() {
  ...
  tmp_var_1_uint = 1;
  A = 0;
  __CPROVER_assume(counter < 100);
  const int __CPAchecker_TMP_0 = counter;
  counter = counter + 1;
  __CPAchecker_TMP_0;
  ...
  __CPROVER_assume(!(q != (local_2c * tmp_var_1_uint)));
  __CPROVER_assume(tmp_var_2_uint < q);
  const int __CPAchecker_TMP_4 = counter;
  counter = counter + 1;
  __CPAchecker_TMP_4;
  __CPROVER_assume(!(counter > 99));
  ...
  __CPROVER_assume(!(counter > 99));
  __CPROVER_assume(tmp_var_2_uint != ((A * local_2c) + p));
  int __CPAchecker_TMP_13;
  __CPAchecker_TMP_13 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"A == q*B + r\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/hard-u_unwindbound100_process_dc_iter1.c", 55, "__PRETTY_FUNCTION__");
}
