...
STATE USEFIRST ARG296 :
    MATCH "typedef union {\n    float value;\n    uint32_t word;\n} ieee_float_shape_type;" -> GOTO ARG297;
    TRUE -> STOP;

STATE USEFIRST ARG297 :
    MATCH "typedef union {\n    float value;\n    uint32_t word;\n} ieee_float_shape_type;" -> GOTO ARG298;
    TRUE -> STOP;

STATE USEFIRST ARG298 :
    MATCH "int __fpclassify_float(float x);" -> GOTO ARG299;
    TRUE -> STOP;

STATE USEFIRST ARG299 :
    MATCH "float fmax_float(float x, float y);" -> GOTO ARG300;
    TRUE -> STOP;

STATE USEFIRST ARG300 :
    MATCH "int __signbit_float(float x);" -> GOTO ARG301;
    TRUE -> STOP;

STATE USEFIRST ARG301 :
    MATCH "void assume(int cond);" -> GOTO ARG302;
    TRUE -> STOP;

STATE USEFIRST ARG302 :
    MATCH "int main(void)" -> GOTO ARG303;
    TRUE -> STOP;

STATE USEFIRST ARG303 :
    MATCH "void __assert_func(const char *file, int line, const char *func, const char *msg)" -> GOTO ARG304;
    TRUE -> STOP;

STATE USEFIRST ARG304 :
    MATCH "void halt_baddata(void)" -> GOTO ARG305;
    TRUE -> STOP;
...
STATE USEFIRST ARG306 :
    MATCH "float in_a0;" -> ASSUME {in_a0 == (0.0);} GOTO ARG307;
    TRUE -> STOP;

STATE USEFIRST ARG307 :
    MATCH "float in_a1;" -> GOTO ARG308;
    TRUE -> STOP;

STATE USEFIRST ARG308 :
    MATCH "float x_00;" -> GOTO ARG309;
    TRUE -> STOP;

STATE USEFIRST ARG309 :
    MATCH "int iVar1;" -> GOTO ARG310;
    TRUE -> STOP;

STATE USEFIRST ARG310 :
    MATCH "uint32_t extraout_var;" -> GOTO ARG311;
    TRUE -> STOP;

STATE USEFIRST ARG311 :
    MATCH "float extraout_fa0;" -> ASSUME {extraout_fa0 == (2.0);} GOTO ARG312;
    TRUE -> STOP;

STATE USEFIRST ARG312 :
    MATCH "x_00 = fmax_float(in_a0, in_a1);" -> GOTO ARG313;
    TRUE -> STOP;

STATE USEFIRST ARG313 :
    MATCH "" -> ASSUME {x == (0.0);} GOTO ARG314;
    TRUE -> STOP;

STATE USEFIRST ARG314 :
    MATCH "float x_00;" -> ASSUME {x == (0.0);} GOTO ARG315;
    TRUE -> STOP;

STATE USEFIRST ARG315 :
    MATCH "uint32_t extraout_var;" -> ASSUME {extraout_var == (0U);} GOTO ARG316;
    TRUE -> STOP;

STATE USEFIRST ARG316 :
    MATCH "x_00 = (float)__fpclassify_float(x);" -> GOTO ARG317;
    TRUE -> STOP;

STATE USEFIRST ARG317 :
    MATCH "x_00 = (float)__fpclassify_float(x);" -> GOTO ARG318;
    TRUE -> STOP;

STATE USEFIRST ARG318 :
    MATCH "" -> ASSUME {x == (0.0);} GOTO ARG319;
    TRUE -> STOP;

STATE USEFIRST ARG319 :
    MATCH "int iVar1;" -> ASSUME {x == (0.0);} GOTO ARG320;
    TRUE -> STOP;

STATE USEFIRST ARG320 :
    MATCH "uint32_t in_fa0;" -> GOTO ARG321;
    TRUE -> STOP;

STATE USEFIRST ARG321 :
    MATCH "ieee_float_shape_type gf_u;" -> ASSUME {(&gf_u) == (4LL);} GOTO ARG322;
    TRUE -> STOP;

STATE USEFIRST ARG322 :
    MATCH "gf_u.value = x;" -> ASSUME {(gf_u.value) == (0.0);} GOTO ARG323;
    TRUE -> STOP;

STATE USEFIRST ARG323 :
    MATCH "in_fa0 = gf_u.word;" -> ASSUME {in_fa0 == (0U);} GOTO ARG324;
    TRUE -> STOP;

STATE USEFIRST ARG324 :
    MATCH "[(in_fa0 == 0) || (in_fa0 == 0x80000000)]" -> ASSUME {in_fa0 == (0U);} GOTO ARG329;
    TRUE -> STOP;

STATE USEFIRST ARG329 :
    MATCH "iVar1 = 2;" -> ASSUME {iVar1 == (2);} GOTO ARG370;
    TRUE -> STOP;
...
STATE USEFIRST ARG372 :
    MATCH "return iVar1;" -> GOTO ARG373;
    TRUE -> STOP;
...
STATE USEFIRST ARG374 :
    MATCH "x_00 = (float)__fpclassify_float(x);" -> ASSUME {x_00 == (2.0);} GOTO ARG375;
    TRUE -> STOP;

STATE USEFIRST ARG375 :
    MATCH "[!((extraout_var != 0) || (x_00 != 0))]" -> ASSUME {extraout_var == (0U);} GOTO ARG377;
    MATCH "[(extraout_var != 0) || (x_00 != 0)]" -> GOTO ARG380;
    TRUE -> STOP;

STATE USEFIRST ARG377 :
    MATCH "[(extraout_var != 0) || (x_00 != 0)]" -> ASSUME {x_00 == (2.0);} GOTO ARG380;
    MATCH "[!((extraout_var != 0) || (x_00 != 0))]" -> GOTO ARG441;
    TRUE -> STOP;

STATE USEFIRST ARG380 :
    MATCH "x_00 = (float)__fpclassify_float(x_00);" -> GOTO ARG381;
    TRUE -> STOP;

STATE USEFIRST ARG381 :
    MATCH "x_00 = (float)__fpclassify_float(x_00);" -> GOTO ARG382;
    TRUE -> STOP;

STATE USEFIRST ARG382 :
    MATCH "" -> ASSUME {x == (2.0);} GOTO ARG383;
    TRUE -> STOP;

STATE USEFIRST ARG383 :
    MATCH "int iVar1;" -> ASSUME {iVar1 == (2);x == (2.0);} GOTO ARG384;
    TRUE -> STOP;

STATE USEFIRST ARG384 :
    MATCH "uint32_t in_fa0;" -> ASSUME {in_fa0 == (0U);} GOTO ARG385;
    TRUE -> STOP;

STATE USEFIRST ARG385 :
    MATCH "ieee_float_shape_type gf_u;" -> ASSUME {(&gf_u) == (4LL);(gf_u.value) == (0.0);(gf_u.word) == (0LL);} GOTO ARG386;
    TRUE -> STOP;

STATE USEFIRST ARG386 :
    MATCH "gf_u.value = x;" -> ASSUME {(gf_u.value) == (2.0);} GOTO ARG387;
    TRUE -> STOP;

STATE USEFIRST ARG387 :
    MATCH "in_fa0 = gf_u.word;" -> ASSUME {in_fa0 == (1073741824U);} GOTO ARG388;
    TRUE -> STOP;

STATE USEFIRST ARG388 :
    MATCH "[!((in_fa0 == 0) || (in_fa0 == 0x80000000))]" -> ASSUME {in_fa0 == (1073741824U);} GOTO ARG390;
    TRUE -> STOP;

STATE USEFIRST ARG390 :
    MATCH "[!((in_fa0 == 0) || (in_fa0 == 0x80000000))]" -> ASSUME {in_fa0 == (1073741824U);} GOTO ARG392;
    TRUE -> STOP;

STATE USEFIRST ARG392 :
    MATCH "[!(((in_fa0 < 0x800000) || (0x7f7fffff < in_fa0)) &&\n               ((in_fa0 < 0x80800000 || (0xff7fffff < in_fa0))))]" -> ASSUME {in_fa0 == (1073741824U);} GOTO ARG395;
    TRUE -> STOP;

STATE USEFIRST ARG395 :
    MATCH "[!(((in_fa0 < 0x800000) || (0x7f7fffff < in_fa0)) &&\n               ((in_fa0 < 0x80800000 || (0xff7fffff < in_fa0))))]" -> ASSUME {in_fa0 == (1073741824U);} GOTO ARG404;
    TRUE -> STOP;

STATE USEFIRST ARG404 :
    MATCH "iVar1 = 4;" -> ASSUME {iVar1 == (4);} GOTO ARG405;
    TRUE -> STOP;
...
STATE USEFIRST ARG436 :
    MATCH "return iVar1;" -> GOTO ARG437;
    TRUE -> STOP;
...
STATE USEFIRST ARG438 :
    MATCH "x_00 = (float)__fpclassify_float(x_00);" -> ASSUME {x_00 == (4.0);} GOTO ARG439;
    TRUE -> STOP;
...
STATE USEFIRST ARG443 :
    MATCH "[(extraout_fa0 != 0.0) || (iVar1 = __signbit_float(x_00), (extraout_var != 0) || (iVar1 != 0))]" -> ASSUME {extraout_fa0 == (2.0);} GOTO ARG467;
    TRUE -> STOP;

STATE USEFIRST ARG467 :
    MATCH "(void) sizeof ((\n# 78 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_req_bl_1252b_process_dc_iter2.c\"\n       0 && \"Assertion failed: extraout_fa0 should be 0.0 and signbit should be 0\"\n# 78 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_req_bl_1252b_process_dc_iter2.c\" 3 4\n       ) ? 1 : 0)" -> GOTO ARG468;
    TRUE -> STOP;
...
STATE USEFIRST ARG471 :
    MATCH "0 && \"Assertion failed: extraout_fa0 should be 0.0 and signbit should be 0\"" -> GOTO ARG472;
    TRUE -> STOP;

STATE USEFIRST ARG472 :
    MATCH "__assert_fail (\n# 78 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_req_bl_1252b_process_dc_iter2.c\"\n       \"0 && \\\"Assertion failed: extraout_fa0 should be 0.0 and signbit should be 0\\\"\"\n# 78 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_req_bl_1252b_process_dc_iter2.c\" 3 4\n       , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_req_bl_1252b_process_dc_iter2.c\", 78, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
