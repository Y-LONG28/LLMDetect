...
union __anon_type_ieee_float_shape_type {
  float value;
  uint32_t word;
} ;
typedef union __anon_type_ieee_float_shape_type ieee_float_shape_type;
...
int main_0();
float fmax_float_1(float x, float y);
int __fpclassify_float_2(float x);
int __fpclassify_float_3(float x);
int main_0() {
  float in_a0;
  float in_a1;
  float x_00;
  ...
  float extraout_fa0;
  x_00 = fmax_float_1(in_a0, in_a1);
  __CPROVER_assume(extraout_fa0 != 0.0);
  int __CPAchecker_TMP_4;
  __CPAchecker_TMP_4 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: extraout_fa0 should be 0.0 and signbit should be 0\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/float_req_bl_1252b_process_dc_iter2.c", 78, "__PRETTY_FUNCTION__");
}
...
float fmax_float_1(float x, float y) {
  ...
  __CPAchecker_TMP_0 = __fpclassify_float_2(x);
  x_00 = (float)__CPAchecker_TMP_0;
  __CPROVER_assume(!(extraout_var != 0));
  __CPROVER_assume(x_00 != 0);
  int __CPAchecker_TMP_1;
  __CPAchecker_TMP_1 = __fpclassify_float_3(x_00);
  x_00 = (float)__CPAchecker_TMP_1;
  return x_00;
}
...
int __fpclassify_float_3(float x) {
  ...
  in_fa0 = gf_u.word;
  __CPROVER_assume(!(in_fa0 == 0));
  __CPROVER_assume(!(in_fa0 == 2147483648U));
  __CPROVER_assume(!(in_fa0 < 8388608));
  __CPROVER_assume(!(2139095039 < in_fa0));
  iVar1 = 4;
  return iVar1;
}
