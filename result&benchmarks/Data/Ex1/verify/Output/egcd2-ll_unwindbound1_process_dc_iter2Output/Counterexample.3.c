...
int main_0() {
  ...
  __assert_fail("0 && \"q*x + s*y == 0\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd2-ll_unwindbound1_process_dc_iter2.c", 56, "__PRETTY_FUNCTION__");
}
