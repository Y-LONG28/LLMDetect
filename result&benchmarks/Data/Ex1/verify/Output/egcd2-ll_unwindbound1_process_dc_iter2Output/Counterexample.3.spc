...
STATE USEFIRST ARG461 :
    MATCH "int tmp_var_2_int;" -> ASSUME {tmp_var_2_int == (2);} GOTO ARG462;
    TRUE -> STOP;

STATE USEFIRST ARG462 :
    MATCH "struct XY xy;" -> ASSUME {(&xy) == (4LL);(xy._4_4_) == (2LL);} GOTO ARG463;
    TRUE -> STOP;
...
STATE USEFIRST ARG475 :
    MATCH "b = (longlong)tmp_var_2_int;" -> ASSUME {b == (2LL);} GOTO ARG476;
    TRUE -> STOP;

STATE USEFIRST ARG476 :
    MATCH "p = (longlong)xy._4_4_;" -> ASSUME {p == (2LL);} GOTO ARG477;
    TRUE -> STOP;
...
STATE USEFIRST ARG498 :
    MATCH "[!((0 < counter) || (p == 0))]" -> ASSUME {p == (2LL);} GOTO ARG500;
    TRUE -> STOP;

STATE USEFIRST ARG500 :
    MATCH "k = b;" -> ASSUME {k == (2LL);} GOTO ARG501;
    TRUE -> STOP;
...
STATE USEFIRST ARG510 :
    MATCH "b = p;" -> ASSUME {b == (2LL);} GOTO ARG511;
    TRUE -> STOP;

STATE USEFIRST ARG511 :
    MATCH "p = k;" -> ASSUME {p == (2LL);} GOTO ARG512;
    TRUE -> STOP;
...
STATE USEFIRST ARG1839 :
    MATCH "[xy._4_4_ * c + tmp_var_2_int * r != 0]" -> GOTO ARG1840;
    TRUE -> STOP;

STATE USEFIRST ARG1840 :
    MATCH "(void) sizeof ((\n# 56 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd2-ll_unwindbound1_process_dc_iter2.c\"\n               0 && \"q*x + s*y == 0\"\n# 56 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd2-ll_unwindbound1_process_dc_iter2.c\" 3 4\n               ) ? 1 : 0)" -> GOTO ARG1842;
    TRUE -> STOP;
...
STATE USEFIRST ARG1845 :
    MATCH "0 && \"q*x + s*y == 0\"" -> GOTO ARG1846;
    TRUE -> STOP;

STATE USEFIRST ARG1846 :
    MATCH "__assert_fail (\n# 56 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd2-ll_unwindbound1_process_dc_iter2.c\"\n               \"0 && \\\"q*x + s*y == 0\\\"\"\n# 56 \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd2-ll_unwindbound1_process_dc_iter2.c\" 3 4\n               , \"/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd2-ll_unwindbound1_process_dc_iter2.c\", 56, __extension__ __PRETTY_FUNCTION__);" -> ERROR;
    TRUE -> STOP;
