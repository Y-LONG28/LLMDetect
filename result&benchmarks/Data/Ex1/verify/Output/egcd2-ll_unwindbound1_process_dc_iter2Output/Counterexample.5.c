...
int main_0() {
  ...
  int tmp_var_2_int;
  struct XY xy;
  assume_1((uint )(0 < tmp_var_2_int));
  assume_2((uint )(0 < (xy._4_4_)));
  ...
  s = 0;
  c = 1;
  assume_3((uint )((((long)tmp_var_2_int) * ((long)(xy._4_4_))) < 2147483647));
  assume_4((uint )((((long)(xy._4_4_)) * ((long)(xy._4_4_))) < 2147483647));
  lVar4 = q;
  lVar3 = s;
  iVar2 = counter + 1;
  __CPROVER_assume(!(0 < counter));
  __CPROVER_assume(!(p == 0));
  k = b;
  _x = 0;
  counter = iVar2;
  _Bool __CPAchecker_TMP_6;
  iVar2 = counter + 1;
  bVar1 = counter < 1;
  counter = iVar2;
  __CPAchecker_TMP_6 = bVar1;
  ...
  __CPROVER_assume(0 < counter);
  counter = iVar2;
  __CPROVER_assume(!((((xy._4_4_) * c) + (tmp_var_2_int * r)) != 0));
  __CPROVER_assume(b != (((xy._4_4_) * s) + (tmp_var_2_int * q)));
  int __CPAchecker_TMP_5;
  __CPAchecker_TMP_5 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"p*x + r*y == a\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/egcd2-ll_unwindbound1_process_dc_iter2.c", 59, "__PRETTY_FUNCTION__");
}
