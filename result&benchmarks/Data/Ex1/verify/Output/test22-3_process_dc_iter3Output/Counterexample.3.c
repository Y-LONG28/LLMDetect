...
struct __anon_type_dummy {
  int a;
  int b;
} ;
typedef struct __anon_type_dummy dummy;
dummy d1 = {  };
dummy d2 = {  };
...
int main_0() {
  ...
  s1 = get_dummy_5();
  pdVar3 = get_dummy_6();
  __CPROVER_assume(pdVar2 != ((dummy *)0));
  __CPROVER_assume(pdVar2 == s1);
  __CPROVER_assume(0 < (s1->a));
  pd1.a = (pdVar3->a) + -10;
  __CPROVER_assume(!((pd1.a) < (pdVar2->a)));
  iVar1 = check_7(s1, pd1.a);
  __CPROVER_assume(((uint32_t )extraout_var) == 0);
  __CPROVER_assume(iVar1 == 0);
  iVar1 = 1048576;
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = 0;
  4UL;
  __VERIFIER_error(); // target state
  __assert_fail("0 && \"Assertion failed: check(s1, pd1.a) should not return 0\"", "/home/zyl/biVerify/CPA_DATA2/C/F/llmfix/realOutput/iterationTry/test22-3_process_dc_iter3.c", 81, "__PRETTY_FUNCTION__");
}
...
int init_1() {
  ...
  assume_2(2147483657U < ((uint32_t )expr_tmp_var_65_int));
  d2.a = local_1c;
  d2.b = local_20;
  assume_3(2147483657U < ((uint32_t )local_1c));
  return extraout_a0;
}
...
dummy *get_dummy_4() {
  long lVar1;
  uint8_t local_11;
  __CPROVER_assume(!(local_11 == '\x0'));
  lVar1 = 488;
  return (dummy *)(lVar1 + 1048576);
}
