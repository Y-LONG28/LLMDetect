...

{
  ...
  assume_abort_if_not((uint)(tmp_var_2_uint < 3));
  assume_abort_if_not((uint)(local_34 < 3));
  y = 1;
  c = (longlong)tmp_var_2_uint;
  _z = 1;
  while( true ) {
    if (((ulong)tmp_var_2_uint * y - y) - c != -1) {
      __assert_func("/home/zyl/biVerify/CPA_DATA2/C/F/process/realOutput/geo1-u_valuebound2_process.c"
