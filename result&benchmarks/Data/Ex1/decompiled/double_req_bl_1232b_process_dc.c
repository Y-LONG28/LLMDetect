...

{
  ...
  if ((extraout_fa0 != 0.0) || (iVar1 = __signbit_double(x_00), CONCAT44(extraout_var,iVar1) != 1))
  {
    __assert_func("/home/zyl/biVerify/CPA_DATA2/C/F/process/realOutput/double_req_bl_1232b_process.c"
                  ,0x51,"main",&_LC1);
  }
  return 0;
}
